...
\restrict zWIgdcBSfa3ZvnOT9CNJbVahbRPjzNcwYTzx8ODEnQfpWZyRHh8qwpIBeBgAHbA
...
ALTER TABLE IF EXISTS ONLY public."Device" DROP CONSTRAINT IF EXISTS fk_device_location;
ALTER TABLE IF EXISTS ONLY public."Staff" DROP CONSTRAINT IF EXISTS "Staff_UserId_fkey";
ALTER TABLE IF EXISTS ONLY public."Staff" DROP CONSTRAINT IF EXISTS "Staff_DepartmentID_fkey";
ALTER TABLE IF EXISTS ONLY public."Event" DROP CONSTRAINT IF EXISTS "Event_StaffID_fkey";
ALTER TABLE IF EXISTS ONLY public."Event" DROP CONSTRAINT IF EXISTS "Event_RelatedReportID_fkey";
ALTER TABLE IF EXISTS ONLY public."Event" DROP CONSTRAINT IF EXISTS "Event_EventTypeID_fkey";
ALTER TABLE IF EXISTS ONLY public."Event" DROP CONSTRAINT IF EXISTS "Event_DeviceID_fkey";
ALTER TABLE IF EXISTS ONLY public."Device" DROP CONSTRAINT IF EXISTS "Device_DeviceCategoryID_fkey";
ALTER TABLE IF EXISTS ONLY public."Device" DROP CONSTRAINT IF EXISTS "Device_DepartmentID_fkey";
ALTER TABLE IF EXISTS ONLY public."DeviceReminderPlan" DROP CONSTRAINT IF EXISTS "DeviceReminderPlan_EventTypeID_fkey";
ALTER TABLE IF EXISTS ONLY public."DeviceReminderPlan" DROP CONSTRAINT IF EXISTS "DeviceReminderPlan_DeviceID_fkey";
ALTER TABLE IF EXISTS ONLY public."DamageReport" DROP CONSTRAINT IF EXISTS "DamageReport_ReportingDepartmentID_fkey";
ALTER TABLE IF EXISTS ONLY public."DamageReport" DROP CONSTRAINT IF EXISTS "DamageReport_ReporterID_fkey";
ALTER TABLE IF EXISTS ONLY public."DamageReport" DROP CONSTRAINT IF EXISTS "DamageReport_HandlerID_fkey";
ALTER TABLE IF EXISTS ONLY public."DamageReport" DROP CONSTRAINT IF EXISTS "DamageReport_DeviceID_fkey";
ALTER TABLE IF EXISTS ONLY public."DamageReportHistory" DROP CONSTRAINT IF EXISTS "DamageReportHistory_DamageReportID_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserTokens" DROP CONSTRAINT IF EXISTS "AspNetUserTokens_UserId_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserRoles" DROP CONSTRAINT IF EXISTS "AspNetUserRoles_UserId_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserRoles" DROP CONSTRAINT IF EXISTS "AspNetUserRoles_RoleId_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserLogins" DROP CONSTRAINT IF EXISTS "AspNetUserLogins_UserId_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserClaims" DROP CONSTRAINT IF EXISTS "AspNetUserClaims_UserId_fkey";
ALTER TABLE IF EXISTS ONLY public."AspNetRoleClaims" DROP CONSTRAINT IF EXISTS "AspNetRoleClaims_RoleId_fkey";
...
DROP INDEX IF EXISTS public.ux_eventtype_code;
DROP INDEX IF EXISTS public.idx_staff_department;
DROP INDEX IF EXISTS public.idx_event_status;
DROP INDEX IF EXISTS public.idx_event_related_report;
DROP INDEX IF EXISTS public.idx_event_device;
DROP INDEX IF EXISTS public.idx_device_reminder_plan_device;
DROP INDEX IF EXISTS public.idx_device_reminder_plan_active_due;
DROP INDEX IF EXISTS public.idx_device_department;
DROP INDEX IF EXISTS public.idx_device_category;
DROP INDEX IF EXISTS public.idx_damage_report_status;
DROP INDEX IF EXISTS public.idx_damage_report_reporter;
DROP INDEX IF EXISTS public.idx_damage_report_maintenance_batch;
DROP INDEX IF EXISTS public.idx_damage_report_history_report;
DROP INDEX IF EXISTS public.idx_damage_report_history_date;
DROP INDEX IF EXISTS public.idx_damage_report_handler;
DROP INDEX IF EXISTS public.idx_damage_report_device;
DROP INDEX IF EXISTS public.idx_damage_report_department;
DROP INDEX IF EXISTS public.idx_damage_report_date;
DROP INDEX IF EXISTS public.idx_aspnet_users_username;
DROP INDEX IF EXISTS public.idx_aspnet_users_email;
...
ALTER TABLE IF EXISTS ONLY public."Staff" DROP CONSTRAINT IF EXISTS "Staff_UserId_unique";
...
ALTER TABLE IF EXISTS ONLY public."Location" DROP CONSTRAINT IF EXISTS "Location_Name_key";
...
ALTER TABLE IF EXISTS ONLY public."DeviceReminderPlan" DROP CONSTRAINT IF EXISTS "DeviceReminderPlan_pkey";
ALTER TABLE IF EXISTS ONLY public."DeviceCategory" DROP CONSTRAINT IF EXISTS "DeviceCategory_pkey";
ALTER TABLE IF EXISTS ONLY public."Department" DROP CONSTRAINT IF EXISTS "Department_pkey";
ALTER TABLE IF EXISTS ONLY public."DamageReport" DROP CONSTRAINT IF EXISTS "DamageReport_pkey";
ALTER TABLE IF EXISTS ONLY public."DamageReportHistory" DROP CONSTRAINT IF EXISTS "DamageReportHistory_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUsers" DROP CONSTRAINT IF EXISTS "AspNetUsers_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUsers" DROP CONSTRAINT IF EXISTS "AspNetUsers_NormalizedUserName_key";
ALTER TABLE IF EXISTS ONLY public."AspNetUsers" DROP CONSTRAINT IF EXISTS "AspNetUsers_NormalizedEmail_key";
ALTER TABLE IF EXISTS ONLY public."AspNetUserTokens" DROP CONSTRAINT IF EXISTS "AspNetUserTokens_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserRoles" DROP CONSTRAINT IF EXISTS "AspNetUserRoles_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserLogins" DROP CONSTRAINT IF EXISTS "AspNetUserLogins_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetUserClaims" DROP CONSTRAINT IF EXISTS "AspNetUserClaims_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetRoles" DROP CONSTRAINT IF EXISTS "AspNetRoles_pkey";
ALTER TABLE IF EXISTS ONLY public."AspNetRoles" DROP CONSTRAINT IF EXISTS "AspNetRoles_NormalizedName_key";
ALTER TABLE IF EXISTS ONLY public."AspNetRoleClaims" DROP CONSTRAINT IF EXISTS "AspNetRoleClaims_pkey";
...
ALTER TABLE IF EXISTS public."PushSubscription" ALTER COLUMN "ID" DROP DEFAULT;
...
ALTER TABLE IF EXISTS public."DeviceReminderPlan" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE IF EXISTS public."Device" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE IF EXISTS public."DamageReportHistory" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE IF EXISTS public."DamageReport" ALTER COLUMN "ID" DROP DEFAULT;
ALTER TABLE IF EXISTS public."AspNetUserClaims" ALTER COLUMN "Id" DROP DEFAULT;
ALTER TABLE IF EXISTS public."AspNetRoleClaims" ALTER COLUMN "Id" DROP DEFAULT;
DROP TABLE IF EXISTS public."Staff";
DROP SEQUENCE IF EXISTS public."PushSubscription_ID_seq";
...
DROP SEQUENCE IF EXISTS public."DeviceReminderPlan_ID_seq";
DROP TABLE IF EXISTS public."DeviceReminderPlan";
DROP TABLE IF EXISTS public."DeviceCategory";
DROP TABLE IF EXISTS public."Device";
DROP TABLE IF EXISTS public."Department";
DROP SEQUENCE IF EXISTS public."DamageReport_ID_seq";
DROP SEQUENCE IF EXISTS public."DamageReportHistory_ID_seq";
DROP TABLE IF EXISTS public."DamageReportHistory";
DROP TABLE IF EXISTS public."DamageReport";
...
DROP TYPE IF EXISTS public.damage_report_status;
DROP TYPE IF EXISTS public.damage_report_priority;
...
--
-- Name: damage_report_priority; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: damage_report_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: DamageReport; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN "DamageReport"."AfterImages"; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory_ID_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory_ID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: DamageReport_ID_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: DamageReport_ID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: DeviceCategory; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan_ID_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan_ID_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: DamageReport ID; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory ID; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan ID; Type: DEFAULT; Schema: public; Owner: -
--
...
79d6f0b0-d8a0-42b6-9623-e9909cc3102e	Supervisor	SUPERVISOR	da0ca988-c9c4-4c01-9081-fd4133e29f85
\.
...
fe60612a-cebd-4bd6-bdcd-e466dfe6e363	d014ebb5-5308-41ec-8a3b-ab95a2eccc23
ad1cf668-28eb-491d-a8cb-015d033b5e9f	79d6f0b0-d8a0-42b6-9623-e9909cc3102e
cd1a1264-4bb8-4dec-bc32-4ba1f8631abf	79d6f0b0-d8a0-42b6-9623-e9909cc3102e
\.
...
fe60612a-cebd-4bd6-bdcd-e466dfe6e363	ntmhuong@gmail.com	NTMHUONG@GMAIL.COM	ntmhuong@gmail.com	NTMHUONG@GMAIL.COM	f	$2a$10$N1N5PiukMfcajmAigtJ1Q.dTwSvt37ls2myVp/UMqEZIOKmniQ0ie	45b6cadd-d2b9-4455-bd3e-d522a5060f6f	b64ace5e-484e-41de-aefb-53482e186c85	\N	f	f	\N	f	0	Ngô Thị Mỹ Hường	2026-04-21 01:46:45.668
ad1cf668-28eb-491d-a8cb-015d033b5e9f	ltthuy@gmail.com	LTTHUY@GMAIL.COM	ltthuy@gmail.com	LTTHUY@GMAIL.COM	f	$2a$10$PXlrUJhBWY1NFzZT4bZxGOuoWT89efALDFEq4RDDU96Fo/nfI4ZAG	8b671e57-b5e0-40c5-9d02-490b617eb737	ef55248e-65fc-458a-8754-31e64aa4e6fb	\N	f	f	\N	f	0	Lê Thị Thủy	2026-04-23 03:14:18.442
\.


--
-- Data for Name: DamageReport; Type: TABLE DATA; Schema: public; Owner: -
--
...
76	\N	Âm thanh hoa đăng rột rẹt.	3	12	3	\N	2026-04-04	2026-04-21	\N	\N	Âm thanh hoa đăng đôi lúc rột rẹt.\nCần kiểm tra	\N	3	2	\N	Kiểm tra main âm thanh	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-04 07:38:13.75887	2026-04-21 01:14:42.38192	\N	\N
...
223	\N	Sửa rèm Hoa đăng	3	12	3	\N	2026-04-17	\N	\N	\N	Sửa lại rèm sảnh hoa đăng	\N	1	2	\N	Đã lên lịch ngày 21/4 xử lý (Khiêm, Hoàng, Trang, Đen). Kỹ thuật bận xử lý máy bơm, kế hoạch hủy thực hiện sau.	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-17 04:23:59.785548	2026-04-21 01:13:52.135875	\N	\N
233	\N	Âm thanh Hoa sen	3	12	3	\N	2026-04-19	\N	\N	\N	Di dời làm kệ để micro Hoa sen khắc phục tình trạng yếu sóng	\N	1	2	\N	Thay đổi không gian làm việc khu vực kỹ thuật Hoa sen trong. Bố trí lại cánh gà, bàn kỹ thuật và thiết bị	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	159c2606-abc5-4006-9633-6926396c181b	2026-04-19 10:21:18.406995	2026-04-22 00:34:09.375167	\N	\N
...
229	279	\N	2	12	2	\N	2026-04-18	2026-05-04	\N	\N	Mất tín hiệu	\N	3	2	\N	Phòng có khách. Chạm dây, đi dây mới	\N	5d7432c9-6978-4b4c-8e32-2228c776a1e3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-18 03:31:39.729013	2026-05-04 07:43:31.289875	\N	\N
224	393	\N	3	12	3	\N	2026-04-15	2026-04-17	\N	\N	Sửa đèn mặt hoa cau	\N	3	2	\N	Phan Thảo sửa xong, đã lắp vào sử dụng	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-17 10:32:41.455481	2026-05-04 07:41:21.430388	\N	\N
...
78	369	\N	3	12	3	\N	2026-04-05	2026-04-05	2026-05-01	\N	Máy load dữ liệu chậm, thường xuyên fullload disk, đầy data	\N	4	2	\N	Đang xử lý chưa xong	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-05 00:13:18.373069	2026-05-01 09:19:03.602006	\N	\N
259	\N	Hoa Sứ	3	12	3	\N	2026-04-24	2026-04-24	2026-04-25	\N	Chuẩn bị và trực âm thanh karaoke Hoa sứ	\N	4	2	\N	Hoàng hỗ trợ	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 09:59:26.231413	2026-04-25 08:09:57.23925	\N	\N
261	\N	Yêu cầu Cô Nữ	3	12	3	\N	2026-04-24	2026-04-24	2026-05-01	\N	Nghiên cứu hộp quà tặng. Khắc chữ Quà tặng Chi Bộ Hòa Giang	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/z7755801624355_6e7734513d0ac44c1076e4f881736370_1777024980108-5KMoNQB3xzVz7oH710TNYtJont2HWm.jpg"]	4	2	\N	Đưa mẫu cho Huy Thanh làm. Xong	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:09.095914	2026-05-01 09:17:44.642001	\N	\N
232	400	\N	2	12	3	\N	2026-04-19	2026-04-19	2026-04-20	\N	Camera bị rơi	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17765905570887803701361860317222_1776590581714-8xcz1ATp4GIx9Lw3hG5LifrvX5kZVi.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/z7741724343250_3e748e7242af1908b5e5a51109804491_1776593860552-j0s6VNctIDiUcjLbYp9Ir9sP40S3P0.jpg"]	4	2	\N	Cam bị rèm kéo làm rớt, cần thay đổi vị trí	\N	5d7432c9-6978-4b4c-8e32-2228c776a1e3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-19 09:23:16.733257	2026-04-20 12:34:34.769757	\N	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17765917693106508295898828983705_1776591783966-MVUDnhh8AN3oGEHByvcNKR5xK23PKS.jpg"]
209	\N	\N	15	1	15	\N	2026-04-21	\N	2026-04-21	\N	Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	\N	4	2	\N	\N	\N	e71a19da-50d2-4fed-8cd2-08e38caa740e	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-14 16:37:32.148378	2026-04-21 00:33:28.027908	batch-2026-04-11-1775899621533	\N
222	\N	\N	15	1	15	\N	2026-04-21	\N	2026-04-21	\N	Bảo trì định kỳ: Xử lý bồn vi sinh nước thảy [Batch: batch-2026-04-11-1775891024445]	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-17 01:00:35.755681	2026-04-21 00:33:46.606008	batch-2026-04-11-1775891024445	\N
244	\N	Hoa sứ	12	4	6	\N	2026-04-20	\N	2026-04-21	\N	Vệ sinh quạt, đèn Hoa sứ	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/den_hoa_su_1776759820945-z4wE1hmgnwdhgRFB5Oe7tJ7SIxMpd7.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/quat_hoa_su_1776759818075-IP1hu12LwUdQuTO2inQcR1IPrApcQu.jpg"]	4	2	\N	Vệ sinh quạt, đèn chỉ vệ sinh được bên ngoài	\N	159c2606-abc5-4006-9633-6926396c181b	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:23:51.9648	2026-04-21 08:24:54.829262	\N	\N
241	\N	Buffet	21	2	2	\N	2026-04-21	2026-04-21	2026-04-21	\N	In lại menu nước buffet	\N	4	2	\N	\N	\N	fe60612a-cebd-4bd6-bdcd-e466dfe6e363	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:50:25.826669	2026-04-21 02:51:38.302851	\N	\N
242	\N	Cài thẻ từ tầng 5 mới	8	14	2	\N	2026-04-21	\N	2026-04-21	\N	Thẻ cũ hư cần cài thẻ mới	\N	4	2	\N	\N	\N	c6f9b9a4-f2c1-4bf7-ba60-61787ca39c5f	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 03:20:03.085099	2026-04-21 03:37:45.948781	\N	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1001023734_1776742646339-Lf9cY6hlV4bluRgixFi6YW24nrrDEW.jpg"]
239	\N	Order ẩm thực lỗi	4	2	3	\N	2026-04-21	2026-04-21	2026-04-21	\N	Xử lý phần mền SMILE PDA lỗi không order bằng tablet được.	\N	4	4	\N	Do dịch vụ IIS bị tắt không rõ nguyên nhân. Đã khởi động lại hoạt động bình thường.	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 23:54:48.916934	2026-04-21 10:31:25.865294	\N	\N
243	\N	Xịt côn trùng	12	4	2	\N	2026-04-21	2026-04-21	2026-04-21	\N	Theo dôi xịt côn trùng nhà hàng, khách sạn	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:16:51.274988	2026-04-21 08:18:39.094395	\N	\N
247	405	\N	3	12	3	\N	2026-04-22	\N	\N	\N	Camera mờ. Cần thay mới	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/NV3__26__Camera13_10_0_1_247_20260422073547_641853_1776818400159-rZc44XALhD6zto2EKAiTBYWgvrHFBn.jpg"]	1	2	\N	\N	\N	159c2606-abc5-4006-9633-6926396c181b	\N	2026-04-22 00:40:11.480673	2026-04-22 00:40:11.480673	\N	\N
240	\N	Triển khai Hệ thống khai báo lưu trú cho người nước ngoài mới 	2	12	2	\N	2026-04-21	2026-04-21	2026-04-21	\N	Website khai báo lưu trú cho người nước ngoài mới được nâng cấp, cần tạo tài khoản mới	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/12_1776731942465-lte4c8ULr191Utnw3OMNbAsrXQoCmF.png", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/yeu_cau_xac_thuc_khai_bao_luu_tru_1776733963080-GCYEs07LiZASo00kIy4KYE8j7hJDEG.jpg"]	4	3	\N	Đã đăng nhập và xác thực thành công. Lễ tân đã sử dụng bình thường.	\N	5d7432c9-6978-4b4c-8e32-2228c776a1e3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:41:35.924525	2026-04-21 08:52:46.979551	\N	\N
246	\N	Order ẩm thực	19	3	3	\N	2026-04-22	2026-04-22	2026-04-22	\N	Phần mềm poswin lỗi. Không ra phiếu order	\N	4	2	\N	Máy in order BẾP bị mất điện, treo order. -> A. Hiền hỗ trợ kiểm tra máy in đã có nguồn. Lệnh treo ở máy THU NGÂN đã được đẩy đi, hoạt động lại bình thường.	\N	159c2606-abc5-4006-9633-6926396c181b	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:10:18.375494	2026-04-22 00:31:42.186875	\N	\N
250	245	\N	2	12	2	\N	2026-04-22	2026-04-22	2026-04-22	\N	Mất tín hiệu do gãy đầu kết nối dây	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1001023747_1776847084555-StnI71SbZkzFB6LWpSxYs6O51OIDPR.jpg"]	4	2	\N	Đã đấu trực tiếp	\N	5d7432c9-6978-4b4c-8e32-2228c776a1e3	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:38:46.807138	2026-04-22 08:44:54.041388	\N	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1001023748_1776847088677-1Fc5Sg71PDbCb6CrMdamof5Tg84Dho.jpg"]
253	\N	Sảnh đón Hoa cau	3	12	3	\N	2026-04-23	\N	2026-04-23	\N	Dọn sảnh đón Hoa cau	\N	4	2	\N	Anh Đen hỗ trợ	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:05:47.875463	2026-04-23 02:51:31.070608	\N	\N
252	\N	Phòng vé HBS	3	12	3	\N	2026-04-23	2026-04-23	2026-04-23	\N	Máy tính không khởi động	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:57:32.923233	2026-04-23 02:52:16.081125	\N	\N
256	\N	Khai báo PCCC	3	12	3	\N	2026-04-24	\N	\N	\N	Khai báo đầy đủ thông tin PCCC	\N	1	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	\N	2026-04-24 01:13:00.451563	2026-04-24 01:13:00.451563	\N	\N
254	\N	Cổng 1	3	12	3	\N	2026-04-23	\N	2026-04-23	\N	Treo băng rôl ATVSTP	\N	4	2	\N	Anh Đen hỗ trợ	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:07:18.165154	2026-04-23 03:04:47.991769	\N	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1776913455614981436473175531084_1776913471275-sgdwopl3J6fPKLOVPjToZl6z8RbLGU.jpg"]
255	\N	Phần mềm BHXH	12	4	3	\N	2026-04-23	\N	2026-04-23	\N	Chuyển đổi CMND -> CCCD cho nhân sự	\N	4	2	\N	Đã yêu cầu VNPT hỗ trợ hướng dẫn chuyển đổi. HC thực hiện.	\N	ad1cf668-28eb-491d-a8cb-015d033b5e9f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:25:02.543835	2026-04-23 03:51:58.4104	\N	\N
257	\N	Phòng họp	3	12	3	\N	2026-04-24	2026-04-24	2026-04-24	\N	Kết nối hợp trực tuyến	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:04.573489	2026-04-24 08:39:17.365337	\N	\N
258	\N	Lễ tân	3	12	2	\N	2026-04-24	2026-04-24	2026-04-24	\N	Kiểm tra mail cho lễ tân	\N	4	2	\N	Lỗi xem danh sách mail.	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:32.569588	2026-04-24 08:40:55.934163	\N	\N
260	\N	Hoa sen	3	12	2	\N	2026-04-24	2026-04-24	2026-04-25	\N	Chuẩn bị Hội nghị, chạy chương trình hội nghị	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:00:41.818093	2026-04-25 08:10:11.980025	\N	\N
251	\N	Họp online phòng họp	3	12	3	\N	2026-04-22	\N	2026-05-01	\N	Chuẩn bị, kết nối phòng hợp zoom 8h ngày 29/4/26	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 09:11:21.26523	2026-05-01 09:18:09.411275	\N	\N
249	\N	DỌN CỔNG HOA, ĐÔN HOA HOA CAU VAO SẢNH	10	5	3	\N	2026-04-22	\N	2026-05-01	\N	NẮNG GIÒN HOA HƯ RỤNG	\N	4	2	\N	\N	\N	2240c223-f17f-41b0-bc48-fe421f619f5e	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 07:18:04.686292	2026-05-01 09:18:26.516534	\N	\N
248	\N	Khu vực ẩm thực	3	12	6	\N	2026-04-19	\N	2026-05-01	\N	Vệ sinh, bảo dưỡng quạt ẩm thực	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 03:37:04.402965	2026-05-01 09:19:44.841671	\N	\N
262	423	\N	3	12	3	\N	2026-04-25	2026-04-25	2026-04-25	\N	Mua mới sử dụng. Mua tại cửa hàng SÁU ĐIỆP (650k hđ lẻ)	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771037435872722805541761180695_1777103761267-ctYDgDPfoyLU941vtm1GCcMcbyMOPX.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771036481482991560901218121089_1777103717799-YRqORXEcZMFapQw8JUzPPJMbMHhWxA.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771035864756104284807070944482_1777103622417-VXjQM1y7brwa92n1F4hpB3tEIOaUnH.jpg"]	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:58:32.845723	2026-04-25 08:06:58.90646	\N	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771042871106365074740403592142_1777104315483-xBFcxKAVN9cVp79n8Mx9rR78xZZXwN.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771037435872722805541761180695_1777103761267-ctYDgDPfoyLU941vtm1GCcMcbyMOPX.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771036481482991560901218121089_1777103717799-YRqORXEcZMFapQw8JUzPPJMbMHhWxA.jpg", "https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771035864756104284807070944482_1777103622417-VXjQM1y7brwa92n1F4hpB3tEIOaUnH.jpg"]
264	\N	Hoa sen + Hoa sứ	3	12	3	\N	2026-04-26	2026-04-26	2026-04-26	\N	Dọn các thiết bị, backdrop, công cụ dụng cụ hội nghị.	\N	4	2	\N	Khiêm + Hoàng	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:16.776973	2026-04-26 04:40:29.918895	\N	\N
263	\N	LỄ TÂN	17	17	3	\N	2026-04-25	\N	2026-05-01	\N	trang web asm không kết nối được với máy scan QR	\N	4	2	\N	Không dùng ASM nữa.	\N	7d54368f-c08c-4315-b902-79e4444718ac	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 16:40:41.997036	2026-05-01 09:17:20.104181	\N	\N
265	\N	\N	15	1	15	\N	2026-05-02	2026-05-02	2026-05-02	\N	Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:20:41.788396	2026-05-02 15:26:10.126316	batch-2026-04-11-1775899621533	\N
266	\N	\N	6	1	6	\N	2026-05-02	2026-05-02	2026-05-02	\N	Bảo trì định kỳ: Thu gôm, vệ sinh các hố nước thảy, bễ mỡ [Batch: batch-2026-04-15-1776217824281]	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:21:22.681969	2026-05-02 15:26:18.527305	batch-2026-04-15-1776217824281	\N
267	\N	\N	6	1	6	\N	2026-05-02	2026-05-02	2026-05-02	\N	Bảo trì định kỳ: BT Hệ thống máy phát điện [Batch: batch-2026-04-22-1776832442223]	\N	4	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:25:50.832126	2026-05-02 15:26:22.536134	batch-2026-04-22-1776832442223	\N
268	\N	\N	6	1	6	\N	2026-05-02	2026-05-02	2026-05-02	\N	Bảo trì định kỳ: BT Hệ thống thang máy [Batch: batch-2026-04-22-1776832559052]	\N	4	2	\N	Thiên nam bảo trì, đã xong	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.146884	2026-05-02 15:30:20.690216	batch-2026-04-22-1776832559052	\N
269	\N	\N	15	1	15	\N	2026-05-02	2026-05-02	2026-05-03	\N	Bảo trì định kỳ: BT phòng GYM [Batch: batch-2026-04-22-1776832499489]	\N	4	2	\N	Hút bụi	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-02 15:31:20.276863	2026-05-03 08:24:30.560081	batch-2026-04-22-1776832499489	\N
270	\N	\N	15	1	15	\N	2026-05-03	2026-05-03	2026-05-03	\N	Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	\N	4	2	\N	1234	\N	e71a19da-50d2-4fed-8cd2-08e38caa740e	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:52.35318	2026-05-03 08:25:15.901985	batch-2026-04-11-1775899621533	\N
272	\N	\N	6	1	6	\N	2026-05-03	2026-05-03	2026-05-03	\N	Bảo trì định kỳ: BT Hệ thống máy giặt, ủi [Batch: batch-2026-04-22-1776832532715]	\N	4	2	\N	Xong	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.674111	2026-05-03 09:22:37.79852	batch-2026-04-22-1776832532715	\N
271	\N	\N	15	1	15	\N	2026-05-03	2026-05-03	2026-05-03	\N	Bảo trì định kỳ: Xử lý bồn vi sinh nước thảy [Batch: batch-2026-04-11-1775891024445]	\N	4	2	\N	Bổ sung mật vi sinh. Xong	\N	e71a19da-50d2-4fed-8cd2-08e38caa740e	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:11.274153	2026-05-03 08:38:27.116882	batch-2026-04-11-1775891024445	\N
273	\N	Sảnh Hoa cau	3	12	3	\N	2026-05-04	\N	\N	\N	Dọn đồ tiệc cưới	\N	1	2	\N	\N	\N	19bc5494-ab7c-4339-ae84-3e3d25355d07	\N	2026-05-04 07:42:05.901341	2026-05-04 07:42:05.901341	\N	\N
\.


--
-- Data for Name: DamageReportHistory; Type: TABLE DATA; Schema: public; Owner: -
--
...
736	271	HandlerNotes	Bổ sung mật vi sinh	Bổ sung mật vi sinh. Xong	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.117389
740	229	HandlerNotes	Phòng có khách	Phòng có khách. Chạm dây, đi dây mới	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:40:32.493997
...
638	232	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 12:34:27.458988
639	232	CompletedDate	2026-04-19T00:00:00.000Z	2026-04-20T12:34:33.277Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 12:34:34.311831
640	239	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 23:55:05.751682
641	209	Status	4	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:32:54.248907
642	222	Status	4	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:06.144436
643	209	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:28.243846
644	222	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:46.821686
645	223	HandlerNotes	Đã lên lịch ngày 21/4 xử lý (Khiêm, Hoàng, Trang, Đen)	Đã lên lịch ngày 21/4 xử lý (Khiêm, Hoàng, Trang, Đen). Kỹ thuật bận xử lý máy bơm, kế hoạch hủy thực hiện sau.	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:13:52.360145
646	76	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:14:10.286914
647	76	HandlerNotes	Đã yêu cầu pham thảo qua kiểm tra. > Thảo hẹn 19/4	Kiểm tra main âm thanh	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:14:42.606035
648	240	Priority	2	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:14:57.347169
649	240	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:14:58.319425
650	241	Status	1	4	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 02:50:13.365968
651	241	CompletedDate		2026-04-21T02:50:16.800Z	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 02:50:17.734266
652	242	Status	1	4	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 03:37:42.470307
653	242	CompletedDate		2026-04-21T03:37:44.499Z	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 03:37:45.504904
654	242	AfterImages	[]	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1001023734_1776742646339-Lf9cY6hlV4bluRgixFi6YW24nrrDEW.jpg"]	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 03:37:46.17127
655	240	HandlerNotes		Đã đăng nhập và xác thực thành công. Cần nghiên cứu cách sử dụng	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 07:55:47.45176
656	243	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:17:21.597638
657	243	CompletedDate	2026-04-21T00:00:00.000Z	2026-04-21T08:17:24.863Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:17:25.908763
658	244	Status	1	4	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:24:48.879255
659	244	CompletedDate		2026-04-21T08:24:53.387Z	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:24:54.390465
660	244	HandlerNotes		Vệ sinh quạt, đèn chỉ vệ sinh được bên ngoài	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:24:55.049117
663	239	Status	4	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:45:06.257742
665	240	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:52:43.730273
666	240	CompletedDate		2026-04-21T08:52:45.564Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:52:46.545276
667	240	HandlerNotes	Đã đăng nhập và xác thực thành công. Cần nghiên cứu cách sử dụng	Đã đăng nhập và xác thực thành công. Lễ tân đã sử dụng bình thường.	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:52:47.197223
668	239	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 10:31:22.147442
669	239	CompletedDate	2026-04-21T00:00:00.000Z	2026-04-21T10:31:25.543Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 10:31:26.518223
670	246	HandlerNotes	Máy in order bị mất điện, treo order. 	Máy in order BẾP bị mất điện, treo order. -> A. Hiền hỗ trợ kiểm tra máy in đã có nguồn. Lệnh treo ở máy thu đã được đẩy đi, hoạt động lại bình thường.	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:30:55.864449
738	272	CompletedDate		2026-05-03T02:22:37.793Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.797614
739	272	HandlerNotes		Xong	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.798875
671	246	HandlerNotes	Máy in order BẾP bị mất điện, treo order. -> A. Hiền hỗ trợ kiểm tra máy in đã có nguồn. Lệnh treo ở máy thu đã được đẩy đi, hoạt động lại bình thường.	Máy in order BẾP bị mất điện, treo order. -> A. Hiền hỗ trợ kiểm tra máy in đã có nguồn. Lệnh treo ở máy THU NGÂN đã được đẩy đi, hoạt động lại bình thường.	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:20.02689
672	246	Status	1	3	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:24.560125
673	246	Status	3	4	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:38.477872
674	246	CompletedDate		2026-04-22T00:31:41.860Z	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:42.850643
675	233	HandlerNotes		Thay đổi không gian làm việc khu vực kỹ thuật Hoa sen trong. Bố trí lại cánh gà, bàn kỹ thuật và thiết bị	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:34:09.594745
676	250	Status	1	4	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:44:49.929401
677	250	CompletedDate	2026-04-22T00:00:00.000Z	2026-04-22T08:44:52.647Z	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:44:53.611509
678	252	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:57:44.624215
679	78	HandlerNotes	Đề Xuất thay ổ cứng. Hẹn 22/4 xử lý	Đang xử lý chưa xong	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:59:42.645412
680	253	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:51:27.129563
681	253	CompletedDate		2026-04-23T02:51:30.743Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:51:31.735059
682	252	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:52:12.321557
683	252	CompletedDate		2026-04-23T02:52:15.759Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:52:16.728802
684	254	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:04:44.431894
685	254	CompletedDate		2026-04-23T03:04:46.605Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:04:47.567718
686	254	AfterImages	[]	["https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/1776913455614981436473175531084_1776913471275-sgdwopl3J6fPKLOVPjToZl6z8RbLGU.jpg"]	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:04:48.204228
687	255	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:51:53.339249
688	255	CompletedDate		2026-04-23T03:51:56.956Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:51:57.965043
689	255	HandlerNotes		Đã yêu cầu VNPT hỗ trợ hướng dẫn chuyển đổi. HC thực hiện.	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:51:58.633313
690	257	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:14.869767
691	257	CompletedDate	2026-04-24T00:00:00.000Z	2026-04-24T08:39:17.037Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:18.023784
692	258	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:51.015278
693	258	CompletedDate	2026-04-24T00:00:00.000Z	2026-04-24T08:40:55.602Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:56.591957
694	261	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:29.705741
695	260	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:33.266118
696	259	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:35.166559
697	262	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:58:58.083135
698	262	CompletedDate	2026-04-25T00:00:00.000Z	2026-04-25T07:59:00.974Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:59:02.009307
699	259	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:09:54.771223
700	259	CompletedDate		2026-04-25T08:09:56.911Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:09:57.890444
701	260	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:10:09.753093
702	260	CompletedDate		2026-04-25T08:10:11.643Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:10:12.641156
703	261	HandlerNotes	Lên mẫu gửi Huy Thanh tư vấn làm hộp mica	Đưa mẫu cho Huy Thanh làm	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 09:09:26.894716
704	264	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:27.348868
705	264	CompletedDate	2026-04-26T00:00:00.000Z	2026-04-26T04:40:29.572Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:30.611815
706	263	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:16.610824
707	263	CompletedDate		2026-05-01T09:17:18.734Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:19.681927
708	263	HandlerNotes		Không dùng ASM nữa.	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:20.315772
709	261	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:39.811761
710	261	CompletedDate		2026-05-01T09:17:43.169Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:44.189596
711	261	HandlerNotes	Đưa mẫu cho Huy Thanh làm	Đưa mẫu cho Huy Thanh làm. Xong	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:44.86866
712	251	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:06.919939
713	251	CompletedDate		2026-05-01T09:18:09.075Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:10.079733
714	249	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:22.701924
715	249	CompletedDate		2026-05-01T09:18:26.178Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:27.185251
716	78	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:59.062867
717	78	CompletedDate		2026-05-01T09:19:03.264Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:19:04.27094
718	248	Status	1	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:19:41.178913
719	248	CompletedDate		2026-05-01T09:19:44.484Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:19:45.554751
720	265	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:10.084977
721	265	CompletedDate		2026-05-02T08:26:10.124Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:10.127937
722	266	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.519875
723	266	CompletedDate		2026-05-02T08:26:18.525Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.528126
724	267	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.528334
725	267	CompletedDate		2026-05-02T08:26:22.534Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.537266
726	268	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.644095
727	268	CompletedDate		2026-05-02T08:30:20.687Z	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.689496
728	268	HandlerNotes	Thiên nam bảo trì	Thiên nam bảo trì, đã xong	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.690614
729	269	Status	3	4	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.470681
730	269	CompletedDate		2026-05-03T01:24:30.559Z	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.561428
731	270	Status	3	4	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.855464
732	270	CompletedDate		2026-05-03T01:25:15.898Z	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.900946
733	270	HandlerNotes	ghi chỉ số	1234	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.902532
734	271	Status	3	4	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:26.967188
735	271	CompletedDate		2026-05-03T01:38:27.112Z	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.116042
737	272	Status	3	4	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.645975
741	224	HandlerNotes	Phan Thảo đã kiểm tra sửa chữa, chờ sửa chữa. Không ảnh hưởng nhiều đến chất lượng ánh sáng sân khấu.	Phan Thảo sửa xong, đã lắp vào sử dụng	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:41:21.431191
742	229	Status	1	3	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:43:31.237391
\.
...
369	Bộ máy vi tính Hạnh - PKD	\N	<p><br></p>	\N	\N	\N	\N	5	3	1	6
...
400	CAM 12-NV3 (Cổng NTH)	\N	<p>Analog</p>	\N	\N	\N	\N	12	1	1	18
405	CAM 13-NV3 (Nha xe cong 3)	\N	\N	\N	\N	\N	\N	12	1	5	29
406	Các tủ đông, tủ mát Hoa cau	\N	\N	\N	\N	\N	\N	1	25	1	5
407	Hầm cầu khách sạn	\N	\N	\N	\N	\N	\N	1	26	1	1
408	Hệ thống tủ điện khách sạn	\N	\N	\N	\N	\N	\N	1	27	1	1
409	Các tủ điện Nhà hàng	\N	\N	\N	\N	\N	\N	1	27	1	36
410	Máy bơm các khu vực	\N	\N	\N	\N	\N	\N	1	23	1	27
411	Quạt điện các khu vực	\N	\N	\N	\N	\N	\N	1	28	1	27
412	Máy phát điện nhà hàng	\N	\N	\N	\N	\N	\N	1	29	1	37
413	Máy phát điện khách sạn	\N	\N	\N	\N	\N	\N	1	29	1	37
414	Cụm PCCC sân vườn	\N	\N	\N	\N	\N	\N	1	30	1	34
415	Cụm PCCC Nhà Hàng	\N	\N	\N	\N	\N	\N	1	30	1	36
416	Máy tập, Dụng cụ phòng GYM	\N	\N	\N	\N	\N	\N	1	31	1	38
417	Máy giặt khách sạn	\N	\N	\N	\N	\N	\N	1	33	1	3
418	Máy sấy khách sạn	\N	\N	\N	\N	\N	\N	1	33	1	3
419	Máy ủi khách sạn	\N	\N	\N	\N	\N	\N	1	33	1	3
420	Thang máy Hoa đăng	\N	\N	\N	\N	\N	\N	1	32	1	8
421	Thanh máy khách sạn	\N	\N	\N	\N	\N	\N	1	32	1	39
422	Thanh tời	\N	\N	\N	\N	\N	\N	1	32	1	7
245	Điện thoại P208		<p><br></p>		\N	\N	\N	12	7	1	\N
423	Máy mài cầm tay DCA ASM03-100A	125030754757	<p>Mua tại cửa hàng SÁU ĐIỆP 650k hđ lẻ.</p>	https://9sddgyotod6gnhxv.public.blob.vercel-storage.com/17771035864756104284807070944482_1777103622417-VXjQM1y7brwa92n1F4hpB3tEIOaUnH.jpg	2026-07-25	2026-04-25	\N	1	22	1	25
427	CAM 2-NH (Loi vao cong 2)	\N	<p>Analog CVBS</p>	\N	\N	\N	\N	12	1	1	34
279	Điện thoại P401		<p><br></p>		\N	\N	\N	12	7	2	\N
\.


--
-- Data for Name: DeviceCategory; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: DeviceReminderPlan; Type: TABLE DATA; Schema: public; Owner: -
--
...
130	406	maintenance	1	Bảo trì Kho lạnh	\N	3	month	\N	2026-05-05 07:00:00	\N	2026-05-05 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776830680972"}	lhkhiem@gmail.com	2026-04-22 11:04:40.972+07	lhkhiem@gmail.com	2026-04-22 11:04:40.972+07
23	156	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.541Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.531Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.101+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:44.605224+07
22	155	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.571Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.556Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.101+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:44.872092+07
16	151	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.696Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.698Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.099+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:46.440415+07
15	150	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.718Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.722Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.098+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:46.708309+07
11	146	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.802Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.814Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.097+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:47.750449+07
10	145	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.824Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.839Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.097+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:48.005946+07
8	32	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.865Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.899Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.096+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:48.529463+07
3	21	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.977Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:51.017Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.093+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:49.841421+07
1	26	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:18.021Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:51.059Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.069+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:50.362047+07
76	205	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.361Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.266Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.121+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:30.648714+07
49	180	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.968Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.912Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.113+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:37.761829+07
43	174	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.099Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.050Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.11+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:39.34243+07
42	173	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.125Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.075Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.109+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:39.600984+07
38	169	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.209Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.176Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.108+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:40.649677+07
37	39	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.240Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.196Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.107+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:40.914575+07
35	168	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.280Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.246Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.107+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:41.452142+07
31	164	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.370Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.334Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.105+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:42.504163+07
30	163	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.392Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.355Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.104+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:42.768335+07
28	161	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.435Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.403Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.103+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:43.294958+07
92	219	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.968Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.912Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.126+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:26.439495+07
70	201	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.497Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.408Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.119+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:32.230878+07
69	200	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.523Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.432Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.119+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:32.499318+07
65	196	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.614Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.528Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.118+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:33.551445+07
64	195	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.637Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.550Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.118+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:33.809381+07
62	193	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.676Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.596Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.117+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:34.330916+07
58	189	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.763Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.693Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.116+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:35.385709+07
57	188	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.785Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.713Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.115+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:35.650408+07
55	186	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.831Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.760Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.115+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:36.183886+07
104	355	maintenance	1	Bảo trì định kỳ máy lạnh	Vệ sinh, kiểm tra vận hành	6	month	\N	2025-11-18 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "rescheduleHistory": [{"reason": "Bảo trì tháng 3 theo lịch Daikin", "toDate": "2026-03-10", "fromDate": "2026-05-18", "rescheduledAt": "2026-02-25T06:52:13.965Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763430857529", "maintenanceProvider": "Daikin Cần Thơ"}	lhkhiem@gmail.com	2025-11-18 08:54:17.529+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:46.343281+07
131	407	maintenance	1	Hút hầm cầu khách sạn	\N	6	month	\N	2026-05-22 07:00:00	\N	2026-11-22 07:00:00	\N	t	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776831198338", "maintenanceProvider": "NA"}	lhkhiem@gmail.com	2026-04-22 11:13:18.338+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:14:02.781259+07
89	216	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.048Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.978Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.125+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:27.233113+07
88	215	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.079Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.998Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.125+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:27.494006+07
139	412	maintenance	1	BT Hệ thống máy phát điện	\N	2	month	\N	2026-04-09 07:00:00	\N	2026-07-02 00:00:00	2026-05-02 15:26:22.536	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832442223"}	lhkhiem@gmail.com	2026-04-22 11:34:02.254+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.540021+07
86	213	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.126Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.041Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.124+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:28.018594+07
85	212	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.145Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.061Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.124+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:28.285126+07
83	210	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.191Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.106Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.124+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:28.810219+07
82	209	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.233Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.137Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.123+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:29.06922+07
80	207	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.277Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.180Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.123+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:29.595161+07
78	206	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.320Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.224Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.122+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:30.122209+07
75	34	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.387Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.296Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.121+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:30.917968+07
68	199	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.544Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.457Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.119+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:32.758795+07
66	197	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.593Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.508Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.118+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:33.28297+07
54	185	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.854Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.782Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.115+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:36.441336+07
53	184	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.875Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.806Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.114+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:36.708496+07
48	179	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.989Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.938Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.113+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:38.018897+07
46	177	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.032Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.983Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.111+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:38.544589+07
44	175	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.077Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.029Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.11+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:39.072406+07
39	170	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.191Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.143Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.108+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:40.390455+07
36	38	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.259Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.220Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.107+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:41.173114+07
34	167	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.303Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.265Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.106+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:41.719543+07
93	220	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.943Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.891Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.126+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:26.182143+07
29	162	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.413Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.376Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.104+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:43.027358+07
27	160	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.457Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.428Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.102+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:43.552525+07
24	157	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.520Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.497Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.101+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:44.345148+07
21	18	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.592Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.583Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.1+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:45.130161+07
19	153	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.632Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.629Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.1+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:45.652819+07
14	149	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.739Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.748Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.098+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:46.965774+07
12	147	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.780Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.792Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.097+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:47.480957+07
9	144	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.844Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.865Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.096+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:48.27198+07
5	31	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.938Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.972Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.094+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:49.316996+07
81	208	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.257Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.161Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.123+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:29.335327+07
74	204	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.408Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.317Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.121+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:31.17801+07
73	203	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.429Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.339Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.12+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:31.446145+07
67	198	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.574Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.488Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.119+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:33.024857+07
63	194	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.655Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.575Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.118+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:34.072369+07
61	192	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.697Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.619Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.117+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:34.599659+07
60	191	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.722Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.644Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.116+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:34.859363+07
59	190	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.743Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.666Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.116+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:35.128583+07
52	183	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.907Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.843Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.114+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:36.967839+07
2	27	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.998Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:51.039Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.092+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:50.095063+07
102	353	maintenance	1	Đầu ghi camera	Vệ sinh, kiểm tra ổ cứng	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test quá hạn", "toDate": "2026-11-14", "fromDate": "2026-11-16", "rescheduledAt": "2025-11-16T08:50:24.966Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Test quá hạn", "toDate": "2025-11-14", "fromDate": "2026-11-14", "rescheduledAt": "2025-11-16T08:50:55.972Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Dời lịch", "toDate": "2025-12-14", "fromDate": "2025-11-14", "rescheduledAt": "2025-11-16T09:43:35.134Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Dời  sau 1 năm", "toDate": "2026-11-14", "fromDate": "2025-12-14", "rescheduledAt": "2025-11-24T09:04:49.047Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-16-1763281121668"}	admin@quanlyvt.com	2025-11-16 15:18:41.669+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-14 15:12:41.495005+07
41	172	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.146Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.096Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.109+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:39.867274+07
33	166	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.324Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.289Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.106+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:41.976966+07
32	165	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.346Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.311Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.105+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:42.245555+07
26	159	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.477Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.452Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.102+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:43.817986+07
25	158	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.497Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.476Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.102+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:44.079515+07
17	33	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.675Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.677Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.099+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:46.177709+07
13	148	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.760Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.769Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.098+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:47.225822+07
7	143	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.895Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.923Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.095+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:48.79667+07
96	223	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.876Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.827Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.127+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:25.378552+07
90	217	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.018Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.956Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.125+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:26.967101+07
79	35	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.297Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.201Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.122+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:29.861144+07
72	202	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.451Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.361Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.12+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:31.707565+07
56	187	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.810Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.739Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.115+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:35.908954+07
45	176	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.056Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.008Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.11+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:38.813895+07
40	171	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.170Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.122Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.108+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:40.126345+07
6	142	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.916Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.949Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.095+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:49.05341+07
107	364	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:16.131Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:28.986+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:32.306159+07
103	48	maintenance	1	Đầu ghi camera	Vệ sinh, kiểm tra ổ cứng	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test quá hạn", "toDate": "2026-11-14", "fromDate": "2026-11-16", "rescheduledAt": "2025-11-16T08:50:24.927Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Test quá hạn", "toDate": "2025-11-14", "fromDate": "2026-11-14", "rescheduledAt": "2025-11-16T08:50:55.949Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Dời lịch", "toDate": "2025-12-14", "fromDate": "2025-11-14", "rescheduledAt": "2025-11-16T09:43:35.102Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "Dời  sau 1 năm", "toDate": "2026-11-14", "fromDate": "2025-12-14", "rescheduledAt": "2025-11-24T09:04:49.008Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-16-1763281121668"}	admin@quanlyvt.com	2025-11-16 15:18:41.678+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-14 15:12:41.268018+07
116	366	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:13.944Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:30.631+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.938676+07
114	368	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:14.426Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:30.274+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.239764+07
108	362	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:15.893Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:29.21+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:32.149736+07
105	23	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:16.614Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	admin@quanlyvt.com	2025-11-18 16:21:07.195+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:32.60316+07
129	399	maintenance	1	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	15	day	\N	2026-04-15 07:00:00	\N	2026-05-17 00:00:00	2026-05-02 15:26:18.527	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-15-1776217824281"}	lhkhiem@gmail.com	2026-04-15 08:50:24.281+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.531113+07
127	392	maintenance	1	Xử lý bồn vi sinh nước thảy	Thêm mật, clo	3	day	\N	2026-04-12 00:00:00	\N	2026-05-06 00:00:00	2026-05-03 08:38:27.118	t	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "sớm", "toDate": "2026-04-17", "fromDate": "2026-04-17", "rescheduledAt": "2026-04-17T00:59:19.706Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775891024445"}	lhkhiem@gmail.com	2026-04-11 14:03:44.445+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.121672+07
126	390	maintenance	1	Hệ thống PCCC	Bảo trì hệ thống	1	month	\N	2026-04-24 07:00:00	\N	2026-05-15 07:00:00	2026-04-15 11:58:47.879	t	{"assignedStaffId": 6, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "dời lịch", "toDate": "2026-04-25", "fromDate": "2026-04-24", "rescheduledAt": "2026-04-10T04:00:23.776Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "test", "toDate": "2026-04-15", "fromDate": "2026-04-25", "rescheduledAt": "2026-04-15T04:14:39.318Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "quay lại bảo trì", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:51:08.923Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Quay lại để test", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:57:56.553Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-05-16", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T05:00:31.026Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-04-16", "fromDate": "2026-05-16", "rescheduledAt": "2026-04-15T05:00:54.185Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "dời lịch test", "toDate": "2026-05-15", "fromDate": "2026-04-16", "rescheduledAt": "2026-04-15T05:42:41.483Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-10-1775793592116"}	lhkhiem@gmail.com	2026-04-10 10:59:52.116+07	lhkhiem@gmail.com	2026-04-15 12:42:42.250722+07
120	377	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:12.974Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.109+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.335624+07
119	376	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:13.214Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:33.932+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.493089+07
118	370	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:13.460Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:31.015+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.639542+07
117	365	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:13.698Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:30.819+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.793035+07
115	367	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:14.179Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:30.443+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.092196+07
47	178	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.010Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.961Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.112+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:38.286434+07
123	379	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:12.246Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.626+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:29.885207+07
121	380	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:12.729Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.282+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.187514+07
113	369	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:14.669Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:30.098+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.393835+07
110	373	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:15.408Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:29.564+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.847666+07
125	381	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:11.760Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.97+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:29.580088+07
111	372	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:15.162Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:29.74+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.700267+07
109	371	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:15.646Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:29.384+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:32.001185+07
128	392	maintenance	1	Theo dõi chỉ số nước thảy	Ghi chỉ số nước trên đồng hồ	1	day	\N	2026-04-12 07:00:00	\N	2026-05-04 00:00:00	2026-05-03 08:25:15.903	t	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test", "toDate": "2026-04-14", "fromDate": "2026-04-14", "rescheduledAt": "2026-04-14T15:57:41.928Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775899621533"}	lhkhiem@gmail.com	2026-04-11 16:27:01.533+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.907611+07
134	415	maintenance	1	Hệ thống PCCC	Bảo trì hệ thống	1	month	\N	2026-04-24 07:00:00	\N	2026-05-15 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "dời lịch", "toDate": "2026-04-25", "fromDate": "2026-04-24", "rescheduledAt": "2026-04-10T04:00:23.776Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "test", "toDate": "2026-04-15", "fromDate": "2026-04-25", "rescheduledAt": "2026-04-15T04:14:39.318Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "quay lại bảo trì", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:51:08.923Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Quay lại để test", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:57:56.553Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-05-16", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T05:00:31.026Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-04-16", "fromDate": "2026-05-16", "rescheduledAt": "2026-04-15T05:00:54.185Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "dời lịch test", "toDate": "2026-05-15", "fromDate": "2026-04-16", "rescheduledAt": "2026-04-15T05:42:41.483Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-10-1775793592116"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:23:39.454+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:23:39.454+07
135	414	maintenance	1	Hệ thống PCCC	Bảo trì hệ thống	1	month	\N	2026-04-24 07:00:00	\N	2026-05-15 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "dời lịch", "toDate": "2026-04-25", "fromDate": "2026-04-24", "rescheduledAt": "2026-04-10T04:00:23.776Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "test", "toDate": "2026-04-15", "fromDate": "2026-04-25", "rescheduledAt": "2026-04-15T04:14:39.318Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "quay lại bảo trì", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:51:08.923Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Quay lại để test", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:57:56.553Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-05-16", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T05:00:31.026Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời sớm test", "toDate": "2026-04-16", "fromDate": "2026-05-16", "rescheduledAt": "2026-04-15T05:00:54.185Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "dời lịch test", "toDate": "2026-05-15", "fromDate": "2026-04-16", "rescheduledAt": "2026-04-15T05:42:41.483Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-10-1775793592116"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:23:39.649+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:23:39.649+07
20	154	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.612Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.607Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.1+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:45.396338+07
18	152	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.654Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.656Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.099+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:45.920197+07
4	141	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:17.957Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:50.996Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.094+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:49.576422+07
136	410	maintenance	1	BT Hệ thống máy bơm	\N	1	month	\N	2026-04-20 07:00:00	\N	2026-05-20 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832356425"}	lhkhiem@gmail.com	2026-04-22 11:32:36.425+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:17.790913+07
138	413	maintenance	1	BT Hệ thống máy phát điện	\N	2	month	\N	2026-04-09 07:00:00	\N	2026-07-02 00:00:00	2026-05-02 15:26:22.536	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832442223"}	lhkhiem@gmail.com	2026-04-22 11:34:02.223+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.539937+07
140	416	maintenance	1	BT phòng GYM	\N	1	week	\N	2026-04-22 07:00:00	\N	2026-05-10 00:00:00	2026-05-03 08:24:30.562	t	{"assignedStaffId": 15, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832499489"}	lhkhiem@gmail.com	2026-04-22 11:34:59.489+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.565485+07
143	419	maintenance	1	BT Hệ thống máy giặt, ủi	\N	1	month	\N	2026-04-25 07:00:00	\N	2026-06-03 00:00:00	2026-05-03 09:22:37.798	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	lhkhiem@gmail.com	2026-04-22 11:35:32.777+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.802929+07
142	418	maintenance	1	BT Hệ thống máy giặt, ủi	\N	1	month	\N	2026-04-25 07:00:00	\N	2026-06-03 00:00:00	2026-05-03 09:22:37.798	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	lhkhiem@gmail.com	2026-04-22 11:35:32.745+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.803+07
141	417	maintenance	1	BT Hệ thống máy giặt, ủi	\N	1	month	\N	2026-04-25 07:00:00	\N	2026-06-03 00:00:00	2026-05-03 09:22:37.798	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	lhkhiem@gmail.com	2026-04-22 11:35:32.715+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.830459+07
124	375	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:12.008Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.798+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:29.725983+07
122	378	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:12.491Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:38:34.453+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:30.029674+07
112	363	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:14.926Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	159c2606-abc5-4006-9633-6926396c181b	2026-03-21 15:24:29.913+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:31.546649+07
106	356	maintenance	1	BT Máy tính	Vệ sinh, backup data	6	month	\N	2025-11-24 07:00:00	\N	2026-09-21 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Bận việc khác", "toDate": "2025-12-01", "fromDate": "2025-11-24", "rescheduledAt": "2025-11-19T04:21:44.903Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "làm sớm", "toDate": "2025-11-19", "fromDate": "2025-12-01", "rescheduledAt": "2025-11-19T08:36:48.921Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Dời muộn", "toDate": "2025-11-23", "fromDate": "2025-11-19", "rescheduledAt": "2025-11-19T08:53:13.734Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Bảo trì sớm", "toDate": "2026-03-21", "fromDate": "2026-05-24", "rescheduledAt": "2026-03-21T08:40:16.376Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-18-1763457667195"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2025-11-19 16:02:29.861+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:39:32.451204+07
137	411	maintenance	1	BT Hệ thống quạt	\N	1	month	\N	2026-04-05 07:00:00	\N	2026-05-05 00:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "Dời lịch", "toDate": "2026-05-05", "fromDate": "2026-04-05", "rescheduledAt": "2026-04-25T08:30:29.037Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-22-1776832410980"}	lhkhiem@gmail.com	2026-04-22 11:33:30.98+07	lhkhiem@gmail.com	2026-04-25 15:30:29.146211+07
133	408	maintenance	1	Bảo trì Hệ thống điện, tủ điện	\N	1	month	\N	2026-05-10 07:00:00	\N	2026-05-10 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776831474876"}	lhkhiem@gmail.com	2026-04-22 11:17:54.91+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:12.884871+07
97	224	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.837Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.803Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.128+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:25.119352+07
95	222	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.897Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.846Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.127+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:25.641777+07
146	422	maintenance	1	BT Hệ thống thang máy	\N	1	month	\N	2026-04-22 07:00:00	\N	2026-06-02 00:00:00	2026-05-02 15:30:20.691	t	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	lhkhiem@gmail.com	2026-04-22 11:35:59.116+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.694608+07
145	421	maintenance	1	BT Hệ thống thang máy	\N	1	month	\N	2026-04-22 07:00:00	\N	2026-06-02 00:00:00	2026-05-02 15:30:20.691	t	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	lhkhiem@gmail.com	2026-04-22 11:35:59.084+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.694681+07
144	420	maintenance	1	BT Hệ thống thang máy	\N	1	month	\N	2026-04-22 07:00:00	\N	2026-06-02 00:00:00	2026-05-02 15:30:20.691	t	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	lhkhiem@gmail.com	2026-04-22 11:35:59.052+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.722466+07
94	221	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.921Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.868Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.127+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:25.912491+07
91	218	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:15.991Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:48.935Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.126+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:26.708676+07
87	214	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.105Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.021Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.125+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:27.75901+07
84	211	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.168Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.083Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.124+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:28.543718+07
77	37	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.341Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.245Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.122+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:30.387876+07
71	36	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.474Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.385Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.12+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:31.973824+07
51	182	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.926Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.863Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.114+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:37.234746+07
50	181	maintenance	1	Bảo trì định kỳ tivi	Vệ sinh, kiểm tra kênh	6	month	\N	2025-11-16 07:00:00	\N	2026-05-16 07:00:00	\N	t	{"assignedStaffId": 3, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "làm sớm", "toDate": "2025-11-16", "fromDate": "2025-12-16", "rescheduledAt": "2025-11-16T08:04:16.947Z", "rescheduledBy": "admin@quanlyvt.com"}, {"reason": "dời lại", "toDate": "2025-12-16", "fromDate": "2025-11-16", "rescheduledAt": "2025-11-16T08:07:49.888Z", "rescheduledBy": "admin@quanlyvt.com"}], "maintenanceBatchId": "batch-2025-11-14-1763130804069"}	admin@quanlyvt.com	2025-11-14 21:33:24.113+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:37.49386+07
132	409	maintenance	1	Bảo trì Hệ thống điện, tủ điện	\N	1	month	\N	2026-05-10 07:00:00	\N	2026-05-10 07:00:00	\N	t	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776831474876"}	lhkhiem@gmail.com	2026-04-22 11:17:54.876+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 11:38:13.137419+07
\.
...
2176	Hoàn thành xử lý - Bục nâng Hoa cau	361	2	Sửa bục nâng không hoạt động	2026-03-25	2026-03-25	6	Kỹ thuật sửa xong.	completed	2026-03-25 11:06:38.098	49	{"source": "damage-report-completion", "damageReportId": 49, "previousStatus": 1}	159c2606-abc5-4006-9633-6926396c181b	2026-03-25 11:06:38.098+07	159c2606-abc5-4006-9633-6926396c181b	2026-03-25 11:06:38.098+07
...
2177	Test Màn hình led Hoa cau	13	7	Test màn led hoa cau.	2026-03-27	2026-03-27	3	Màn hình bình thường, không lỗi mới phát sinh	completed	2026-03-27 14:54:02.223	61	{"source": "damage-report-completion", "damageReportId": 61, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-03-27 14:54:02.223+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-03-27 14:54:02.223+07
2178	Hoàn thành xử lý - Bảng chữ HBRGRS tầng 6	12	2	Tủ điện đèn tầng 6 cháy CB điện.\nTủ nguồn đèn led cháy	2026-03-31	2026-03-31	6	Đã dọn đám cháy, Huy thanh kiểm tra sửa chữa.\nHuy thanh Đã thay nguồn và tủ.	completed	2026-03-31 02:23:43.941	62	{"source": "damage-report-completion", "damageReportId": 62, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-03-31 09:23:43.941+07	159c2606-abc5-4006-9633-6926396c181b	2026-03-31 09:23:43.941+07
2179	Hoàn thành xử lý - Máy lạnh Toshiba - Hoa Mai	384	2	Máy lạnh không có nguồn	2026-04-02	2026-04-02	6	Đứt dây nguồn, đấu lại dây nguồn. Máy hđ bình thường.	completed	2026-04-02 10:08:43.081	71	{"source": "damage-report-completion", "damageReportId": 71, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-02 17:08:43.081+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-02 17:08:43.081+07
2180	Hoàn thành xử lý - Bộ máy vi tính Thúy - PKT	356	2	Máy không lên nguồn	2026-04-03	2026-04-03	2	Ổ ghim điện bị lỏng ko ăn điện, thay ổ ghim	completed	2026-04-03 02:32:38.921	72	{"source": "damage-report-completion", "damageReportId": 72, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 09:32:38.921+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 09:32:38.921+07
2181	Hoàn thành xử lý - Máy lạnh Toshiba - Hoa Mai	384	2	Máy lạnh không có nguồn	2026-04-02	2026-04-03	6	Đứt dây nguồn, đấu lại dây nguồn. Máy hđ bình thường.	completed	2026-04-03 03:10:55.666	71	{"source": "damage-report-completion", "damageReportId": 71, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:10:55.666+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:10:55.666+07
2182	Hoàn thành xử lý - Máy lạnh Hoa đăng sảnh đón	386	2	Máy lạnh ko lạnh. Chạy lúc rồi chớp đèn liên tục.	2026-04-03	2026-04-03	3	Kiểm tra, bơm gas	completed	2026-04-03 03:12:15.19	73	{"source": "damage-report-completion", "damageReportId": 73, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:12:15.19+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:12:15.19+07
2183	Hoàn thành xử lý - Bộ máy vi tính Thúy - PKT	356	2	Máy không lên nguồn	2026-04-03	2026-04-03	2	Ổ ghim điện bị lỏng ko ăn điện, thay ổ ghim	completed	2026-04-03 03:23:27.665	72	{"source": "damage-report-completion", "damageReportId": 72, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:23:27.665+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:23:27.665+07
2184	Hoàn thành xử lý - Máy lạnh Hoa đăng sảnh đón	386	2	Máy lạnh ko lạnh. Chạy lúc rồi chớp đèn liên tục.	2026-04-03	2026-04-03	3	Kiểm tra, bơm gas	completed	2026-04-03 10:28:11.159	73	{"source": "damage-report-completion", "damageReportId": 73, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:28:11.159+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-03 10:28:11.159+07
2185	Hoàn thành xử lý - Bộ đàm Phục Vụ (5)	47	10	Nhận 5 tai nghe từ Khiêm\nBàn giao lại cho Quầy bar sử dụng 1 đàm + 1 sạc + 1 tai nghe	2026-04-05	2026-04-05	4	Pv 5 đàm, sạc, tai nghe.\nBar 1 đàm, 1 sạc, 1 tai nghe	completed	2026-04-05 09:48:56.367	82	{"source": "damage-report-completion", "damageReportId": 82, "previousStatus": 1}	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:48:56.367+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:48:56.367+07
2186	Hoàn thành xử lý - Bộ đàm Quầy bar - Thu ngân (1)	46	10	Nhận 1 bộ đàm + 1 sạc + tai nghe từ Phục vụ (Hiền)	2026-04-05	2026-04-05	3	Nhận 1 đàm, sạc, tai nghe	completed	2026-04-05 09:49:55.88	81	{"source": "damage-report-completion", "damageReportId": 81, "previousStatus": 1}	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:49:55.88+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:49:55.88+07
2187	Hoàn thành xử lý - Màn hình led Hoa đăng	6	2	Màn led hư 1 tấm.	2026-04-05	2026-04-05	3	Thay led dự phòng. Bình thường	completed	2026-04-05 09:53:41.877	75	{"source": "damage-report-completion", "damageReportId": 75, "previousStatus": 1}	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:53:41.877+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-05 16:53:41.877+07
2188	Hoàn thành xử lý - Máy lạnh Hoa sen Daikin	387	2	Máy lạnh sảnh trước có 1 dàn lạnh kêu to	2026-04-07	2026-04-07	\N	Daikin đã kiểm tra. Máy hết kêu và hoạt động bình thường	completed	2026-04-07 01:55:03.363	104	{"source": "damage-report-completion", "damageReportId": 104, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-07 08:55:03.363+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-07 08:55:03.363+07
2189	Hoàn thành thay CB Màn hình led Hoa cau	13	2	CB điện Màn led hoa cau nhá điện khi bật.	2026-04-07	2026-04-07	3	Thay CB điện cho màn led.	completed	2026-04-07 04:06:42.876	77	{"source": "damage-report-completion", "damageReportId": 77, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-07 11:06:42.876+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-07 11:06:42.876+07
2190	Hoàn thành xử lý - Bộ máy vi tính Tú - PKT	23	2	Máy tính không kết nối máy in, không in được	2026-04-08	2026-04-08	3	Fix Kaspersky chặn mạng lan.	completed	2026-04-08 01:01:09.125	111	{"source": "damage-report-completion", "damageReportId": 111, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2026-04-08 08:01:09.125+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-08 08:01:09.125+07
2191	Hoàn thành chuyển tivi lên phòng họp	383	10	Dời tivi lên phòng họp để sử dụng cho các cuộc họp trực tuyến	2026-04-08	2026-04-08	3	Đã hoàn thành, sử dụng bình thường	completed	2026-04-08 03:09:07.895	114	{"source": "damage-report-completion", "damageReportId": 114, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-08 10:09:07.895+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-08 10:09:07.895+07
2192	Hoàn thành xử lý - Bộ máy vi tính mượn HBS (KD2)	370	2	Máy tính không kết nối với máy in màu, không in được thực đơn	2026-04-07	2026-04-08	3	Đã cài đặt xong	completed	2026-04-08 09:15:58.635	110	{"source": "damage-report-completion", "damageReportId": 110, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-08 16:15:58.635+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-08 16:15:58.635+07
2193	Hoàn thành xử lý - Tivi  P204	26	7	Tivi bị hột mè	2026-04-03	2026-04-09	2	Phòng có khách	completed	2026-04-09 01:54:44.962	69	{"source": "damage-report-completion", "damageReportId": 69, "previousStatus": 3}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-09 08:54:44.962+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-09 08:54:44.962+07
2194	Hoàn thành xử lý - Bộ máy vi tính Thúy - PKT	356	2	Máy không lên nguồn	2026-04-03	2026-04-10	2	Ổ ghim điện bị lỏng ko ăn điện, thay ổ ghim	completed	2026-04-10 08:42:47.522	72	{"source": "damage-report-completion", "damageReportId": 72, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 08:42:47.522+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 08:42:47.522+07
2195	Hoàn thành xử lý - Máy lạnh Toshiba - Hoa Mai	384	2	Máy lạnh không có nguồn	2026-04-02	2026-04-10	6	Đứt dây nguồn, đấu lại dây nguồn. Máy hđ bình thường.	completed	2026-04-10 08:43:49.26	71	{"source": "damage-report-completion", "damageReportId": 71, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 08:43:49.26+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 08:43:49.26+07
2199	Hoàn thành xử lý - Máy lạnh Toshiba RAS-H81C3KCVG-V	355	7	Kiem tra trung lap su kien	2026-04-10	2026-04-10	\N	Đây là sự kiện test, không có thật	completed	2026-04-10 04:26:46.025	\N	{"source": "damage-report-completion", "damageReportId": 134, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:26:46.025+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:26:46.025+07
2201	Hoàn thành xử lý - Máy lạnh Toshiba RAS-H81C3KCVG-V	355	7	Test sự kiện	2026-04-10	2026-04-10	6	Kiểm tra, không có thật	completed	2026-04-10 11:39:35.86	136	{"source": "damage-report-completion", "damageReportId": 136, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:39:35.86+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:39:35.86+07
2202	Hoàn thành sửa chữa bục nâng hoa cau	361	2	Bục nâng Hoa cau hư không sử dụng đc.	2026-04-07	2026-04-10	6	Cháy motor. Kỹ thuật hẹn t3, ngày 7/4/25 - Đã mang thợ kiểm tra - Đã sửa motor chưa lắp - Đang lắp motor - Đã sửa xong, hđbt	completed	2026-04-10 11:42:51.738	83	{"source": "damage-report-completion", "damageReportId": 83, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:42:51.738+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:42:51.738+07
2203	Hoàn thành xử lý - Màn hình led Hoa cau	13	2	Màn led hoa đăng hư 2 tấm led	2026-04-10	2026-04-10	3	Hư jack nguồn, đã sửa. Dời một số tấm led hư ở giữa xuống góc. Hđbt	completed	2026-04-10 10:43:35.357	137	{"source": "damage-report-completion", "damageReportId": 137, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 17:43:35.357+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 17:43:35.357+07
2204	Hoàn thành xử lý - Két sắt P101	391	2	Két sắt hư bản lề	2026-04-10	2026-04-10	3	Bản lề bị lỏng chốt gài, đã cố định lại, hđbt	completed	2026-04-10 23:23:27.13	139	{"source": "damage-report-completion", "damageReportId": 139, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 06:23:27.13+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 06:23:27.13+07
2205	Hoàn thành xử lý - Bảng chữ HBRGRS tầng 6	12	5	Hư chữ "H" trong chữ RẠCH	2026-04-10	2026-04-11	3	Nhờ Huy Thanh kiểm tra. Hẹn 9/7 kiểm tra. Hẹn 10/4\nHuy Thanh Nguồn, hđbt	completed	2026-04-11 13:26:10.647	112	{"source": "damage-report-completion", "damageReportId": 112, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 13:25:37.661+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 13:26:12.766881+07
2207	Hoàn thành xử lý - Máy lạnh Toshiba RAS-18SKCV	394	10	Tháo board nóng cho Phòng Hoa hồng mượn.	2026-04-11	2026-04-11	3	Đã tháo board. Máy ko hoạt động.	completed	2026-04-11 08:41:42.92	143	{"source": "damage-report-completion", "damageReportId": 143, "previousStatus": 1}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 15:41:42.92+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 15:41:42.92+07
2208	Hoàn thành xử lý - Máy lạnh Toshiba RAS 18SKCV	395	5	Thay board nóng Máy lạnh Hoa hồng.	2026-04-11	2026-04-11	3	Đã thay xong - > Bình thường	completed	2026-04-11 16:12:00.732	144	{"source": "damage-report-completion", "damageReportId": 144, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:12:00.732+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:12:00.732+07
2206	Hoàn thành xử lý - Máy lạnh Toshiba RAS 18SKCV	395	12	Máy lỗi chớp đèn đỏ. Lúc chuẩn bị hội nghị	2026-04-11	2026-04-11	3	Báo daikin tình trạng. Hẹn sáng 4/4 xử lý.\nSáng 4/4 daikin qua kiểm tra báo hư board -> Mượn board Phòng họp nhỏ sử dụng.\n11/4 Daikn  thay board mới, hđbt.	completed	2026-04-11 16:15:00.715	142	{"source": "damage-report-completion", "damageReportId": 142, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 15:32:15.023+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:15:03.186656+07
2209	Hoàn thành xử lý - Máy lạnh Toshiba RAS-18SKCV	394	10	Trả board nóng máy lạnh	2026-04-11	2026-04-11	3	Đã xong, hoạt động bình thường.	completed	2026-04-11 16:38:08.778	145	{"source": "damage-report-completion", "damageReportId": 145, "previousStatus": 1}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:38:08.778+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:38:08.778+07
2210	Hoàn thành xử lý - Bộ máy vi tính Tú - PKT	23	2	Máy tính không kết nối máy in nữa rồi	2026-04-11	2026-04-11	3	Đã xử lý xong	completed	2026-04-11 16:41:56.613	140	{"source": "damage-report-completion", "damageReportId": 140, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:41:56.613+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-11 16:41:56.613+07
2212	Hoàn thành xử lý - Tivi P503	212	2	Tivi tự kích hoạt kênh digital, chuyển về analog	2026-04-13	2026-04-13	3	Tivi tự kích hoạt kênh digital, chuyển về analog 	completed	2026-04-13 01:12:40.497	200	{"source": "damage-report-completion", "damageReportId": 200, "previousStatus": 1}	159c2606-abc5-4006-9633-6926396c181b	2026-04-13 08:12:40.497+07	159c2606-abc5-4006-9633-6926396c181b	2026-04-13 08:12:40.497+07
2213	Hoàn thành xử lý - Máy in màu EPSON L310	397	2	Máy nghẹt đầu phun, clean đầu phun	2026-04-13	2026-04-13	3	Máy nghẹt đầu phun, clean đầu phun. Đầu phun đã nghẹt nặng không xử lý được, sử dụng tạm với chất lượng tương đối.	completed	2026-04-13 03:26:15.323	196	{"source": "damage-report-completion", "damageReportId": 196, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-13 10:26:15.323+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-13 10:26:15.323+07
2198	Hoàn thành xử lý - Máy lạnh Toshiba RAS-H81C3KCVG-V	355	7	Kiem tra trung lap su kien	2026-04-10	2026-04-10	\N	Đây là sự kiện test, không có thật	completed	2026-04-10 04:21:36.605	\N	{"source": "damage-report-completion", "damageReportId": 134, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:21:36.605+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:21:36.605+07
2200	Hoàn thành xử lý - Máy lạnh Toshiba RAS-H81C3KCVG-V	355	7	Kiem tra trung lap su kien (5)	2026-04-10	2026-04-10	\N	Đây là sự kiện test, không có thật	completed	2026-04-10 11:35:47.094	\N	{"source": "damage-report-completion", "damageReportId": 134, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:27:57.883+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-10 11:35:48.823892+07
2214	Hoàn thành xử lý - Điện thoại P410	288	12	Điện thoại tự động gọi số tổng đài, có tiếng chuông chờ	2026-04-03	2026-04-14	2	Tiếp tục theo dõi	completed	2026-04-14 00:55:00.329	70	{"source": "damage-report-completion", "damageReportId": 70, "previousStatus": 3}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-14 07:55:00.329+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-14 07:55:00.329+07
2215	Hoàn thành xử lý - Bộ máy vi tính Tú - PKT	23	2	không kết nối được máy in	2026-04-14	2026-04-14	3	Lỗi spooler, Upadate windows	completed	2026-04-14 14:42:37.214	207	{"source": "damage-report-completion", "damageReportId": 207, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-14 14:42:37.214+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-14 14:42:37.214+07
2075	Hoàn thành xử lý - CAM 10-NV2 (Bx KS)	17	9	Camera mất hình	2025-11-13	2026-04-15	3	Kiểm tra đường dây và camera	completed	2026-04-15 01:42:06.527	17	{"source": "damage-report-completion", "handlerNotes": "Kiểm tra đường dây và camera, \\nCamera đứt cáp và hư balun", "damageReportId": 17, "previousStatus": 3}	159c2606-abc5-4006-9633-6926396c181b	2025-11-13 16:39:23.473+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 08:42:08.579057+07
2217	Hoàn thành xử lý - Hệ thống đèn sân khấu Hoa cau	393	12	Đèn mặt sân khấu hư 1 cây	2026-04-15	2026-04-15	3	Tháo đèn xuống không làm ảnh hướng các đèn khác. Ánh sáng đủ dùng. Đã báo Phan Thảo kiểm tra sửa chữa.	completed	2026-04-15 01:37:44.147	141	{"source": "damage-report-completion", "damageReportId": 141, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 08:37:44.147+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 08:37:44.147+07
2220	Hệ thống PCCC	390	1	Bảo trì hệ thống	2026-04-15	2026-04-15	6	Đã xong	completed	2026-04-15 07:00:00	221	{"assignedStaffId": 6, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "dời lịch", "toDate": "2026-04-25", "fromDate": "2026-04-24", "rescheduledAt": "2026-04-10T04:00:23.776Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "test", "toDate": "2026-04-15", "fromDate": "2026-04-25", "rescheduledAt": "2026-04-15T04:14:39.318Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "quay lại bảo trì", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:51:08.923Z", "rescheduledBy": "lhkhiem@gmail.com"}, {"reason": "Quay lại để test", "toDate": "2026-04-15", "fromDate": "2026-05-14", "rescheduledAt": "2026-04-15T04:57:56.553Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-10-1775793592116"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 11:37:08.874+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 11:58:54.949223+07
2221	Hoàn thành xử lý - CAM 30-KS (Cua sau ks)	398	2	Tín hiệu không ổn định	2026-04-17	2026-04-17	3	Chạm dây tín hiệu dưới hầm	completed	2026-04-17 09:44:57.679	211	{"source": "damage-report-completion", "damageReportId": 211, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-17 16:44:57.679+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-17 16:44:57.679+07
2224	Hoàn thành xử lý - Bộ máy vi tính Trang - PKT	365	2	Xử lý máy tính không có internet	2026-04-20	2026-04-20	2	Lỏng dây LAN	completed	2026-04-20 02:24:03.165	238	{"source": "damage-report-completion", "damageReportId": 238, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 09:24:03.165+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 09:24:03.165+07
2216	Bảo trì định kỳ - Hố vi sinh xử lý nước thảy	392	1	Báo cáo bảo trì định kỳ cho đợt: Xử lý bồn vi sinh nước thảy. Ghi chú: Lập báo cáo thủ công từ danh sách bảo trì	2026-04-15	2026-04-21	15		completed	2026-04-15 07:00:00	222	{"assignedStaffId": 15, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-11-1775891024445"}	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-04-15 08:28:15.884+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-04-21 07:33:47.253039+07
2227	Hoàn thành xử lý - Điện thoại P208	245	2	Mất tín hiệu do gãy đầu kết nối dây	2026-04-22	2026-04-22	2	Đã đấu trực tiếp	completed	2026-04-22 08:44:52.647	250	{"source": "damage-report-completion", "damageReportId": 250, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 15:44:52.647+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 15:44:52.647+07
2228	Hoàn thành xử lý - Máy mài cầm tay DCA ASM03-100A	423	8	Mua mới sử dụng. Mua tại cửa hàng SÁU ĐIỆP (650k hđ lẻ)	2026-04-25	2026-04-25	3		completed	2026-04-25 07:59:00.974	262	{"source": "damage-report-completion", "damageReportId": 262, "previousStatus": 1}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 14:59:00.974+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 14:59:00.974+07
2222	Hoàn thành xử lý - CAM 3 - NhaHang (San sau Hoa Cau)	388	2	Mất hình. Nguồn đủ 12V. Không có tín hiệu từ dây	2026-04-17	2026-04-17	3	Đứt dây tín hiệu trên tầng 2 nhà hàng tròn	completed	2026-04-17 09:45:55.809	131	{"source": "damage-report-completion", "damageReportId": 131, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-17 16:45:55.809+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-17 16:45:55.809+07
2223	Hoàn thành xử lý - CAM 12-NV3 (Cổng NTH)	400	2	Camera bị rơi	2026-04-19	2026-04-20	3	Đã xử lý xong	completed	2026-04-20 12:34:33.277	232	{"source": "damage-report-completion", "damageReportId": 232, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-19 16:43:35.992+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 19:34:35.916672+07
2225	Hoàn thành xử lý - CAM 29-NV3 (Nha Banh)	404	2	Xử lý camera mất màu	2026-04-20	2026-04-20	2		completed	2026-04-20 03:06:40.818	236	{"source": "damage-report-completion", "damageReportId": 236, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 10:06:40.818+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 10:06:40.818+07
2211	Bảo trì định kỳ - Hố vi sinh xử lý nước thảy	392	1	Số nước 123	2026-04-21	2026-04-21	15		completed	2026-04-21 00:00:00	209	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test", "toDate": "2026-04-14", "fromDate": "2026-04-14", "rescheduledAt": "2026-04-14T15:57:41.928Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775899621533"}	dd27e8f9-50a0-4de0-9a5a-9b9f1396f9c9	2026-04-12 07:16:42.628+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 07:33:29.104053+07
2266	Hoàn thành xử lý - Bộ máy vi tính Hạnh - PKD	369	3	Máy load dữ liệu chậm, thường xuyên fullload disk, đầy data	2026-04-05	2026-05-01	3	Đang xử lý chưa xong	completed	2026-05-01 09:19:03.264	78	{"source": "damage-report-completion", "damageReportId": 78, "previousStatus": 3}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 16:19:03.264+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 16:19:03.264+07
2226	Hoàn thành xử lý - CAM 28-PLV(Nha xe Hoa sen)	403	2	Xử lý camera bị lệch góc quay	2026-04-20	2026-04-20	2		completed	2026-04-20 03:06:54.168	235	{"source": "damage-report-completion", "damageReportId": 235, "previousStatus": 1}	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 10:06:54.168+07	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 10:06:54.168+07
2218	Bảo trì định kỳ - Hố vi sinh xử lý nước thảy	392	1	Báo cáo bảo trì định kỳ cho đợt: Xử lý bồn vi sinh nước thảy. Ghi chú: Lập báo cáo thủ công từ danh sách bảo trì	2026-04-21	2026-04-21	15		completed	2026-04-21 00:00:00	222	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "sớm", "toDate": "2026-04-17", "fromDate": "2026-04-17", "rescheduledAt": "2026-04-17T00:59:19.706Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775891024445"}	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-04-15 11:10:55.409+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 07:33:47.683668+07
2269	Theo dõi chỉ số nước thảy	392	1	Ghi chỉ số nước trên đồng hồ	2026-05-02	2026-05-02	15		completed	2026-05-02 07:00:00	265	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test", "toDate": "2026-04-14", "fromDate": "2026-04-14", "rescheduledAt": "2026-04-14T15:57:41.928Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775899621533"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:20:41.695+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:10.129245+07
2283	BT Hệ thống thang máy	422	1		2026-05-02	2026-05-02	6	Thiên nam bảo trì	completed	2026-05-02 07:00:00	268	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.005+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.691425+07
2287	Theo dõi chỉ số nước thảy	392	1	Ghi chỉ số nước trên đồng hồ	2026-05-03	2026-05-03	15	1234	completed	2026-05-03 07:00:00	270	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "test", "toDate": "2026-04-14", "fromDate": "2026-04-14", "rescheduledAt": "2026-04-14T15:57:41.928Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775899621533"}	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:52.278+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.904665+07
2290	BT Hệ thống máy giặt, ủi	418	1		2026-05-03	2026-05-03	6	Xong	completed	2026-05-03 07:00:00	272	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.625+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.799795+07
2291	BT Hệ thống máy giặt, ủi	417	1		2026-05-03	2026-05-03	6	Xong	completed	2026-05-03 07:00:00	272	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.648+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.799795+07
2219	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	399	1	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	2026-04-15	2026-05-02	3		completed	2026-04-15 07:00:00	266	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-15-1776217824281"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-15 11:13:16.619+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.528791+07
2276	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	399	1	Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	2026-05-02	2026-05-02	6		completed	2026-05-02 07:00:00	266	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-15-1776217824281"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:21:22.657+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.528791+07
2284	BT Hệ thống thang máy	421	1		2026-05-02	2026-05-02	6	Thiên nam bảo trì	completed	2026-05-02 07:00:00	268	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.087+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.691425+07
2285	BT Hệ thống thang máy	420	1		2026-05-02	2026-05-02	6	Thiên nam bảo trì	completed	2026-05-02 07:00:00	268	{"cost": 0, "assignedStaffId": 6, "maintenanceType": "outsource", "maintenanceBatchId": "batch-2026-04-22-1776832559052", "maintenanceProvider": "NA"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.124+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.691425+07
2288	Xử lý bồn vi sinh nước thảy	392	1	Thêm mật, clo	2026-05-03	2026-05-03	15	Bổ sung mật vi sinh. Xong	completed	2026-05-03 07:00:00	271	{"assignedStaffId": 15, "maintenanceType": "internal", "rescheduleHistory": [{"reason": "sớm", "toDate": "2026-04-17", "fromDate": "2026-04-17", "rescheduledAt": "2026-04-17T00:59:19.706Z", "rescheduledBy": "lhkhiem@gmail.com"}], "maintenanceBatchId": "batch-2026-04-11-1775891024445"}	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:11.23+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.118549+07
2281	BT Hệ thống máy phát điện	412	1		2026-05-02	2026-05-02	6		completed	2026-05-02 07:00:00	267	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832442223"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:25:50.786+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.538015+07
2282	BT Hệ thống máy phát điện	413	1		2026-05-02	2026-05-02	6		completed	2026-05-02 07:00:00	267	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832442223"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:25:50.809+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.538015+07
2286	BT phòng GYM	416	1		2026-05-02	2026-05-02	15	Ghi chú bên bảo trì	completed	2026-05-02 07:00:00	269	{"assignedStaffId": 15, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832499489"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:31:20.233+07	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.563268+07
2289	BT Hệ thống máy giặt, ủi	419	1		2026-05-03	2026-05-03	6	Xong	completed	2026-05-03 07:00:00	272	{"assignedStaffId": 6, "maintenanceType": "internal", "maintenanceBatchId": "batch-2026-04-22-1776832532715"}	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.583+07	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.799795+07
\.
...
256	Báo cáo đã hoàn thành ✅	Báo cáo: Xử lý máy tính không có internet... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 02:24:02.821386
301	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Camera mờ. Cần thay mới	report	new	/dashboard/damage-reports	\N	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:40:12.3603
302	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Camera mờ. Cần thay mới	report	new	/dashboard/damage-reports	3	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:40:12.830865
309	Báo cáo hư hỏng mới ⚠️	Trần Minh Hoàng: Mất tín hiệu do gãy đầu kết nối dây	report	new	/dashboard/damage-reports	\N	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:38:47.839621
310	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Mất tín hiệu do gãy đầu kết nối dây	report	new	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:38:48.329348
325	Báo cáo hư hỏng mới ⚠️	Lê Thị Thủy: Chuyển đổi CMND -> CCCD cho nhân sự	report	new	/dashboard/damage-reports	\N	t	ad1cf668-28eb-491d-a8cb-015d033b5e9f	2026-04-23 03:25:03.096697
326	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Chuyển đổi CMND -> CCCD cho nhân sự	report	new	/dashboard/damage-reports	3	t	ad1cf668-28eb-491d-a8cb-015d033b5e9f	2026-04-23 03:25:03.808274
335	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Kiểm tra mail cho lễ tân	report	new	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:33.454329
...
336	Báo cáo đã hoàn thành ✅	Báo cáo: Kiểm tra mail cho lễ tân... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:55.257824
...
253	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Xử lý máy tính không có internet	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 02:04:36.415407
254	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Xử lý máy tính không có internet	report	new	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 02:04:36.523982
255	🔔 Nhắc nhở tiến độ công việc	Quản lý đang yêu cầu bạn cập nhật tiến độ công việc #238 (Bộ máy vi tính Trang - PKT). Vui lòng sớm hoàn thành.	report	reminder	/dashboard/damage-reports	2	t	lhkhiem@gmail.com	2026-04-20 02:04:46.78
311	Báo cáo đã hoàn thành ✅	Báo cáo: Mất tín hiệu do gãy đầu kết nối dây... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-22 08:44:52.301236
337	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Chuẩn bị và trực âm thanh karaoke Hoa sứ	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 09:59:26.707863
338	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Chuẩn bị và trực âm thanh karaoke Hoa sứ	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 09:59:27.196352
339	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Chuẩn bị Hội nghị, chạy chương trình hội nghị	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:00:42.263629
340	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Chuẩn bị Hội nghị, chạy chương trình hội nghị	report	new	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:00:42.718337
341	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Nghiên cứu hộp quà tặng. Khắc chữ Quà tặng Chi Bộ Hòa Giang	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:09.554915
342	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Nghiên cứu hộp quà tặng. Khắc chữ Quà tặng Chi Bộ Hòa Giang	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:10.02174
343	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Nghiên cứu hộp quà tặng. Khắc chữ Quà tặng Chi Bộ ...	report	in_progress	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:31.386272
345	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Chuẩn bị và trực âm thanh karaoke Hoa sứ...	report	in_progress	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:36.740538
257	Báo cáo đã hoàn thành ✅	Báo cáo: Thu dọn backdrop, Trả lại dàn âm thanh cho Hoa Mai... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 03:05:12.99338
259	Báo cáo đã hoàn thành ✅	Báo cáo: Xử lý camera bị lệch góc quay... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 03:06:53.83897
260	🔔 Nhắc nhở tiến độ công việc	Quản lý đang yêu cầu bạn cập nhật tiến độ công việc #230 (Quạt ẩm thực). Vui lòng sớm hoàn thành.	report	reminder	/dashboard/damage-reports	6	t	lhkhiem@gmail.com	2026-04-20 09:14:59.261066
261	Báo cáo đã hoàn thành ✅	Báo cáo: Camera bị rơi... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 12:34:32.642395
262	Sự kiện hoàn thành ✅	Lê Hoàng Khiêm đã hoàn thành: Hoàn thành xử lý - CAM 12-NV3 (Cổng NTH)	system	completed	/dashboard/events	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 12:34:36.374329
263	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Xử lý phần mền SMILE PDA lỗi không order bằng tablet được.	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 23:54:49.387755
264	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Xử lý phần mền SMILE PDA lỗi không order bằng tablet được.	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 23:54:49.873858
265	Báo cáo đã hoàn thành ✅	Báo cáo: Xử lý phần mền SMILE PDA lỗi không order bằng tabl... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-20 23:55:07.336785
266	Sự kiện hoàn thành ✅	Trần Văn Đen đã hoàn thành: Bảo trì định kỳ - Hố vi sinh xử lý nước thảy	system	completed	/dashboard/events	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:23.796348
...
287	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Vệ sinh quạt, đèn Hoa sứ	report	new	/dashboard/damage-reports	6	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:23:52.895777
276	Báo cáo hư hỏng mới ⚠️	Ngô Thị Mỹ Hường: In lại mune nước buffet	report	new	/dashboard/damage-reports	\N	t	fe60612a-cebd-4bd6-bdcd-e466dfe6e363	2026-04-21 01:50:26.4429
277	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: In lại mune nước buffet	report	new	/dashboard/damage-reports	3	t	fe60612a-cebd-4bd6-bdcd-e466dfe6e363	2026-04-21 01:50:27.180041
278	Báo cáo đã hoàn thành ✅	Báo cáo: In lại mune nước buffet... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 02:50:16.208982
280	Báo cáo hư hỏng mới ⚠️	Ngô Thanh Tuyền: Thẻ cũ hư cần cài thẻ mới	report	new	/dashboard/damage-reports	\N	t	c6f9b9a4-f2c1-4bf7-ba60-61787ca39c5f	2026-04-21 03:20:03.714358
281	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Thẻ cũ hư cần cài thẻ mới	report	new	/dashboard/damage-reports	2	t	c6f9b9a4-f2c1-4bf7-ba60-61787ca39c5f	2026-04-21 03:20:04.442414
283	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Theo dôi xịt côn trùng nhà hàng, khách sạn	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:16:51.773646
284	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Theo dôi xịt côn trùng nhà hàng, khách sạn	report	new	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:16:52.290818
288	Báo cáo đã hoàn thành ✅	Báo cáo: Vệ sinh quạt, đèn Hoa sứ... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:24:53.032014
290	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Test	report	new	/dashboard/damage-reports	6	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:41:00.484174
291	Báo cáo đã hoàn thành ✅	Báo cáo: Vệ sinh bụi và vô dầu... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	t	dd27e8f9-50a0-4de0-9a5a-9b9f1396f9c9	2026-04-21 08:44:34.102039
293	Báo cáo đang được xử lý 🛠️	Dương Hoàng Trang đang xử lý báo cáo: Vệ sinh bụi và vô dầu...	report	in_progress	/dashboard/damage-reports	6	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:46:11.990203
294	Báo cáo đã hoàn thành ✅	Báo cáo: Website khai báo lưu trú cho người nước ngoài mới ... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:52:45.235801
295	Báo cáo đã hoàn thành ✅	Báo cáo: Xử lý phần mền SMILE PDA lỗi không order bằng tabl... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 10:31:24.978538
258	Báo cáo đã hoàn thành ✅	Báo cáo: Xử lý camera mất màu... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-20 03:06:40.479861
268	Có 1 bảo trì sắp đến hạn 📅	Có 1 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-21 00:33:33.370547
269	Sự kiện hoàn thành ✅	Trần Văn Đen đã hoàn thành: Bảo trì định kỳ - Hố vi sinh xử lý nước thảy	system	completed	/dashboard/events	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:43.976745
270	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: Xử lý bồn vi sinh nước thảy	maintenance	completed	/dashboard/maintenance	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:48.760428
271	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-21 00:33:50.645442
279	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: In lại mune nước buffet	report	new	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 02:51:19.450595
348	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-04-25 00:25:07.899653
349	Có 1 bảo trì sắp đến hạn 📅	Có 1 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-04-25 07:49:45.087213
357	Có 1 bảo trì sắp đến hạn 📅	Có 1 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-04-26 00:22:42.801661
362	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-05-01 04:24:29.544818
369	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-05-02 00:15:44.351143
292	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Xử lý phần mền SMILE PDA lỗi không order bằng tabl...	report	in_progress	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:45:09.140781
267	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: Theo dõi chỉ số nước thảy	maintenance	completed	/dashboard/maintenance	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 00:33:30.184976
274	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Âm thanh hoa đăng đôi lúc rột rẹt.\nCần kiểm tra...	report	in_progress	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:14:13.131208
275	Báo cáo đang được xử lý 🛠️	Trần Minh Hoàng đang xử lý báo cáo: Website khai báo lưu trú cho người nước ngoài mới ...	report	in_progress	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 01:15:01.19653
...
289	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Test	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:41:00.048699
297	Báo cáo hư hỏng mới ⚠️	Thu Ngân: Phần mềm poswin lỗi. Không ra phiếu order	report	new	/dashboard/damage-reports	\N	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:10:18.846498
...
272	Báo cáo hư hỏng mới ⚠️	Trần Minh Hoàng: Website khai báo lưu trú cho người nước ngoài mới được nâng cấp, cần tạo tài khoản mới	report	new	/dashboard/damage-reports	\N	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 00:41:36.502849
273	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Website khai báo lưu trú cho người nước ngoài mới được nâng cấp, cần tạo tài khoản mới	report	new	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 00:41:37.200894
282	Báo cáo đã hoàn thành ✅	Báo cáo: Thẻ cũ hư cần cài thẻ mới... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	5d7432c9-6978-4b4c-8e32-2228c776a1e3	2026-04-21 03:37:44.161146
285	Báo cáo đã hoàn thành ✅	Báo cáo: Theo dôi xịt côn trùng nhà hàng, khách sạn... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-21 08:17:24.518908
286	Báo cáo hư hỏng mới ⚠️	Lê Thị Thủy: Vệ sinh quạt, đèn Hoa sứ	report	new	/dashboard/damage-reports	\N	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-21 08:23:52.417168
296	Có 1 bảo trì sắp đến hạn 📅	Có 1 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-22 00:07:35.501452
344	Báo cáo đang được xử lý 🛠️	Trần Minh Hoàng đang xử lý báo cáo: Chuẩn bị Hội nghị, chạy chương trình hội nghị...	report	in_progress	/dashboard/damage-reports	2	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 10:03:36.182355
298	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Phần mềm poswin lỗi. Không ra phiếu order	report	new	/dashboard/damage-reports	3	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:10:19.528107
299	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Phần mềm poswin lỗi. Không ra phiếu order...	report	in_progress	/dashboard/damage-reports	3	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:27.374567
300	Báo cáo đã hoàn thành ✅	Báo cáo: Phần mềm poswin lỗi. Không ra phiếu order... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	159c2606-abc5-4006-9633-6926396c181b	2026-04-22 00:31:41.314585
303	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Vệ sinh, bảo dưỡng quạt ẩm thực	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 03:37:04.491987
304	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Vệ sinh, bảo dưỡng quạt ẩm thực	report	new	/dashboard/damage-reports	6	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 03:37:04.577051
305	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-22 04:35:46.37137
306	Có 4 bảo trì sắp đến hạn 📅	Có 4 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-22 04:43:41.397027
307	Báo cáo hư hỏng mới ⚠️	Nguyễn Thị Hạnh: NẮNG GIÒN HOA HƯ RỤNG	report	new	/dashboard/damage-reports	\N	t	2240c223-f17f-41b0-bc48-fe421f619f5e	2026-04-22 07:18:05.302293
308	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: NẮNG GIÒN HOA HƯ RỤNG	report	new	/dashboard/damage-reports	3	t	2240c223-f17f-41b0-bc48-fe421f619f5e	2026-04-22 07:18:06.018329
312	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Chuẩn bị, kết nối phòng hợp zoom 8h ngày 29/4/26	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 09:11:21.763078
313	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Chuẩn bị, kết nối phòng hợp zoom 8h ngày 29/4/26	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-22 09:11:22.257668
314	Có 3 bảo trì sắp đến hạn 📅	Có 3 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-23 00:23:17.29019
315	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Máy tính không khởi động	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:57:33.377953
316	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Máy tính không khởi động	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:57:33.938653
317	Báo cáo đang được xử lý 🛠️	Lê Hoàng Khiêm đang xử lý báo cáo: Máy tính không khởi động...	report	in_progress	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 00:57:47.482191
318	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Dọn sảnh đón Hoa cau	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:05:48.351314
319	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Dọn sảnh đón Hoa cau	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:05:48.848958
320	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Treo băng rôl ATVSTP	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:07:18.631819
321	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Treo băng rôl ATVSTP	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:07:19.107835
322	Báo cáo đã hoàn thành ✅	Báo cáo: Dọn sảnh đón Hoa cau... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:51:30.123562
323	Báo cáo đã hoàn thành ✅	Báo cáo: Máy tính không khởi động... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 02:52:15.18578
324	Báo cáo đã hoàn thành ✅	Báo cáo: Treo băng rôl ATVSTP... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:04:45.996755
327	Báo cáo đã hoàn thành ✅	Báo cáo: Chuyển đổi CMND -> CCCD cho nhân sự... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-23 03:51:56.34005
328	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	t	\N	2026-04-24 00:18:52.019389
329	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Khai báo đầy đủ thông tin PCCC	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 01:13:01.010586
330	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Khai báo đầy đủ thông tin PCCC	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 01:13:01.486056
331	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Kết nối hợp trực tuyến	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:05.057851
332	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Kết nối hợp trực tuyến	report	new	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:05.550554
333	Báo cáo đã hoàn thành ✅	Báo cáo: Kết nối hợp trực tuyến... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:39:16.43687
334	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Kiểm tra mail cho lễ tân	report	new	/dashboard/damage-reports	\N	t	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-24 08:40:33.008475
346	Có 2 bảo trì sắp đến hạn 📅	Có 2 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-04-24 10:04:07.032903
347	🔔 Nhắc nhở tiến độ công việc	Quản lý đang yêu cầu bạn cập nhật tiến độ công việc #248 (Khu vực ẩm thực). Vui lòng sớm hoàn thành.	report	reminder	/dashboard/damage-reports	6	f	lhkhiem@gmail.com	2026-04-24 10:05:52.21263
350	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Mua mới sử dụng. Mua tại cửa hàng SÁU ĐIỆP (650k hđ lẻ)	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:58:33.821945
351	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Mua mới sử dụng. Mua tại cửa hàng SÁU ĐIỆP (650k hđ lẻ)	report	new	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:58:34.270916
352	Báo cáo đã hoàn thành ✅	Báo cáo: Mua mới sử dụng. Mua tại cửa hàng SÁU ĐIỆP (650k h... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 07:59:00.386182
353	Báo cáo đã hoàn thành ✅	Báo cáo: Chuẩn bị và trực âm thanh karaoke Hoa sứ... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:09:56.308253
354	Báo cáo đã hoàn thành ✅	Báo cáo: Chuẩn bị Hội nghị, chạy chương trình hội nghị... đã được hoàn thành.	report	completed	/dashboard/damage-reports	2	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-25 08:10:11.299447
355	Báo cáo hư hỏng mới ⚠️	Quách Kiến Quang: trang web asm không kết nối được với máy scan QR	report	new	/dashboard/damage-reports	\N	f	7d54368f-c08c-4315-b902-79e4444718ac	2026-04-25 16:40:42.458221
356	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: trang web asm không kết nối được với máy scan QR	report	new	/dashboard/damage-reports	3	f	7d54368f-c08c-4315-b902-79e4444718ac	2026-04-25 16:40:43.15382
358	Báo cáo hư hỏng mới ⚠️	Lê Hoàng Khiêm: Dọn các thiết bị, backdrop, công cụ dụng cụ hội nghị.	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:17.343253
359	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Dọn các thiết bị, backdrop, công cụ dụng cụ hội nghị.	report	new	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:17.796454
360	Báo cáo đã hoàn thành ✅	Báo cáo: Dọn các thiết bị, backdrop, công cụ dụng cụ hội ng... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-04-26 04:40:28.974369
361	🔔 Nhắc nhở tiến độ công việc	Quản lý đang yêu cầu bạn cập nhật tiến độ công việc #263 (LỄ TÂN). Vui lòng sớm hoàn thành.	report	reminder	/dashboard/damage-reports	3	f	lhkhiem@gmail.com	2026-04-26 06:04:26.093108
363	Báo cáo đã hoàn thành ✅	Báo cáo: trang web asm không kết nối được với máy scan QR... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:18.143445
364	Báo cáo đã hoàn thành ✅	Báo cáo: Nghiên cứu hộp quà tặng. Khắc chữ Quà tặng Chi Bộ ... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:17:42.613995
365	Báo cáo đã hoàn thành ✅	Báo cáo: Chuẩn bị, kết nối phòng hợp zoom 8h ngày 29/4/26... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:08.480592
366	Báo cáo đã hoàn thành ✅	Báo cáo: NẮNG GIÒN HOA HƯ RỤNG... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:18:25.603285
367	Báo cáo đã hoàn thành ✅	Báo cáo: Máy load dữ liệu chậm, thường xuyên fullload disk,... đã được hoàn thành.	report	completed	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:19:02.675612
368	Báo cáo đã hoàn thành ✅	Báo cáo: Vệ sinh, bảo dưỡng quạt ẩm thực... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-01 09:19:44.137835
370	Báo cáo hư hỏng mới ⚠️	Trần Văn Đen: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:20:41.805715
371	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	report	new	/dashboard/damage-reports	15	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:20:41.821969
386	Bảo trì đã thực hiện 🔧	Dương Hoàng Trang đã hoàn thành bảo trì: BT Hệ thống thang máy	maintenance	completed	/dashboard/maintenance	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.727225
395	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch:... đã được hoàn thành.	report	completed	/dashboard/damage-reports	15	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.890691
404	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: BT Hệ thống máy giặt, ủi [Batch: ... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.783185
372	Báo cáo hư hỏng mới ⚠️	Dương Hoàng Trang: Bảo trì định kỳ: Thu gôm, vệ sinh các hố nước thảy, bễ mỡ [Batch: batch-2026-04-15-1776217824281]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:21:22.686402
373	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: Thu gôm, vệ sinh các hố nước thảy, bễ mỡ [Batch: batch-2026-04-15-1776217824281]	report	new	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:21:22.697304
387	Báo cáo hư hỏng mới ⚠️	Trần Văn Đen: Bảo trì định kỳ: BT phòng GYM [Batch: batch-2026-04-22-1776832499489]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:31:20.286626
388	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: BT phòng GYM [Batch: batch-2026-04-22-1776832499489]	report	new	/dashboard/damage-reports	15	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:31:20.296019
396	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: Theo dõi chỉ số nước thảy	maintenance	completed	/dashboard/maintenance	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.908804
405	Bảo trì đã thực hiện 🔧	Dương Hoàng Trang đã hoàn thành bảo trì: BT Hệ thống máy giặt, ủi	maintenance	completed	/dashboard/maintenance	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:37.835249
374	Báo cáo hư hỏng mới ⚠️	Dương Hoàng Trang: Bảo trì định kỳ: BT Hệ thống máy phát điện [Batch: batch-2026-04-22-1776832442223]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:25:50.837508
375	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: BT Hệ thống máy phát điện [Batch: batch-2026-04-22-1776832442223]	report	new	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:25:50.850776
389	Sự kiện hoàn thành ✅	Trần Văn Đen đã hoàn thành: BT phòng GYM	system	completed	/dashboard/events	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-02 15:32:35.208813
397	Báo cáo hư hỏng mới ⚠️	Trần Văn Đen: Bảo trì định kỳ: Xử lý bồn vi sinh nước thảy [Batch: batch-2026-04-11-1775891024445]	report	new	/dashboard/damage-reports	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:11.282643
398	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: Xử lý bồn vi sinh nước thảy [Batch: batch-2026-04-11-1775891024445]	report	new	/dashboard/damage-reports	15	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:11.305409
406	Có 5 bảo trì sắp đến hạn 📅	Có 5 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-05-04 07:39:49.809824
376	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch:... đã được hoàn thành.	report	completed	/dashboard/damage-reports	15	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:10.116589
378	Có 3 bảo trì sắp đến hạn 📅	Có 3 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-05-02 15:26:16.253446
380	Bảo trì đã thực hiện 🔧	Dương Hoàng Trang đã hoàn thành bảo trì: Thu gôm, vệ sinh các hố nước thảy, bễ mỡ	maintenance	completed	/dashboard/maintenance	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.53238
390	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: BT phòng GYM [Batch: batch-2026-0... đã được hoàn thành.	report	completed	/dashboard/damage-reports	15	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.537531
399	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: Xử lý bồn vi sinh nước thảy [Batc... đã được hoàn thành.	report	completed	/dashboard/damage-reports	15	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.103451
407	Báo cáo sự cố mới ⚠️	Lê Hoàng Khiêm: Dọn đồ tiệc cưới	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:42:05.906445
408	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Dọn đồ tiệc cưới	report	new	/dashboard/damage-reports	3	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:42:05.917191
377	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: Theo dõi chỉ số nước thảy	maintenance	completed	/dashboard/maintenance	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:10.134701
379	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: Thu gôm, vệ sinh các hố nước thảy... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:18.52209
381	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: BT Hệ thống máy phát điện [Batch:... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.53009
382	Bảo trì đã thực hiện 🔧	Dương Hoàng Trang đã hoàn thành bảo trì: BT Hệ thống máy phát điện	maintenance	completed	/dashboard/maintenance	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:26:22.540901
391	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: BT phòng GYM	maintenance	completed	/dashboard/maintenance	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:30.5665
400	Bảo trì đã thực hiện 🔧	Trần Văn Đen đã hoàn thành bảo trì: Xử lý bồn vi sinh nước thảy	maintenance	completed	/dashboard/maintenance	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:38:27.122622
409	Báo cáo đang được xử lý 🛠️	Trần Minh Hoàng đang xử lý báo cáo: Mất tín hiệu...	report	in_progress	/dashboard/damage-reports	2	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-04 07:43:31.282263
383	Báo cáo hư hỏng mới ⚠️	Dương Hoàng Trang: Bảo trì định kỳ: BT Hệ thống thang máy [Batch: batch-2026-04-22-1776832559052]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.154261
384	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: BT Hệ thống thang máy [Batch: batch-2026-04-22-1776832559052]	report	new	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:27:11.160935
392	Báo cáo hư hỏng mới ⚠️	Trần Văn Đen: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	report	new	/dashboard/damage-reports	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:52.373445
393	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: Theo dõi chỉ số nước thảy [Batch: batch-2026-04-11-1775899621533]	report	new	/dashboard/damage-reports	15	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:24:52.392005
401	Có 6 bảo trì sắp đến hạn 📅	Có 6 đợt bảo trì dự kiến thực hiện trong 7 ngày tới.	maintenance	upcoming	/dashboard/maintenance	\N	f	\N	2026-05-03 08:41:15.254566
385	Báo cáo đã hoàn thành ✅	Báo cáo: Bảo trì định kỳ: BT Hệ thống thang máy [Batch: bat... đã được hoàn thành.	report	completed	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-02 15:30:20.674167
394	Sự kiện hoàn thành ✅	Trần Văn Đen đã hoàn thành: Theo dõi chỉ số nước thảy	system	completed	/dashboard/events	\N	f	e71a19da-50d2-4fed-8cd2-08e38caa740e	2026-05-03 08:25:15.52218
402	Báo cáo sự cố mới ⚠️	Dương Hoàng Trang: Bảo trì định kỳ: BT Hệ thống máy giặt, ủi [Batch: batch-2026-04-22-1776832532715]	report	new	/dashboard/damage-reports	\N	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.679649
403	Công việc mới được giao 📋	Bạn được giao xử lý báo cáo: Bảo trì định kỳ: BT Hệ thống máy giặt, ủi [Batch: batch-2026-04-22-1776832532715]	report	new	/dashboard/damage-reports	6	f	19bc5494-ab7c-4339-ae84-3e3d25355d07	2026-05-03 09:22:22.689924
\.
...
32	dd27e8f9-50a0-4de0-9a5a-9b9f1396f9c9	https://fcm.googleapis.com/fcm/send/f55YIFAad9M:APA91bHJM4_iOf6Rg0dfxf0CojakgiEJtyCT6Q12JG5rmPe_-EVKFAZgd52airoRAKmskw87sIXymDfPnKGqdsoniBJjwPC4sqFwr5mXyGpWD5MCj_wZvPpF-pcxcJp8dzoGwSPYYadG	BLK-tGzQN_xwzwSgb6TPPDwY0nK0HUgCr3VkwDrDT1isRPY3FYOjJVjOk39BSzdJI0buwTfK3SNmDQOcSDsGg-4	dY1pFXDUszF3FzWBLaFd2w	2026-04-21 08:40:01.181938
33	159c2606-abc5-4006-9633-6926396c181b	https://fcm.googleapis.com/fcm/send/eztCRzZQOuY:APA91bFV_p-Qy1x2D1Ci_gfOI8n7pb4UqJMoWHdXoJ_2f-CL15ag7QMgPM9x-ozhf68v5JtdZh0dgXFER2Qo20gV9QeM5KKOUxhK9yNRgZYCTJXLpKryCo7G6R48R3Ii0HW85670NgJI	BMAUpe0H9mcSQsaBn-5otTR-ElIBQu665MK0UyXz27ws6TzAvTo7OYp30SokckdUBQ71NjbBNRD24HRzRUBV9i0	VPxdapxQKlX4oqM-BU8Urw	2026-04-22 00:26:12.989023
34	19bc5494-ab7c-4339-ae84-3e3d25355d07	https://fcm.googleapis.com/fcm/send/fQH2jX_BJ9w:APA91bG-BjjheK7nvVOi-kG5DPOEnQkol2_giHQ5ARwAqT9LMzLwPyrkd7TB_Lu7hGhQ8s5eBSwzh4YChV6ColNvVMF9KxkpG0pUYPxMLxwPVbn1t8xKI11GM05xhanFnlgblgq2WYF1	BNAyePkfgadksnG7-GVRIhZTIC4TOfBpAV7F9n79Pf_LF_hEPadoe7D7OM2XyqsuRtKoGfUFCEii8nzolXagATk	Rm4Dpoxa6X4FA7PUCgOHIg	2026-04-22 06:55:06.811213
35	19bc5494-ab7c-4339-ae84-3e3d25355d07	https://fcm.googleapis.com/fcm/send/eztCRzZQOuY:APA91bFV_p-Qy1x2D1Ci_gfOI8n7pb4UqJMoWHdXoJ_2f-CL15ag7QMgPM9x-ozhf68v5JtdZh0dgXFER2Qo20gV9QeM5KKOUxhK9yNRgZYCTJXLpKryCo7G6R48R3Ii0HW85670NgJI	BMAUpe0H9mcSQsaBn-5otTR-ElIBQu665MK0UyXz27ws6TzAvTo7OYp30SokckdUBQ71NjbBNRD24HRzRUBV9i0	VPxdapxQKlX4oqM-BU8Urw	2026-04-24 10:04:01.806736
36	ad1cf668-28eb-491d-a8cb-015d033b5e9f	https://fcm.googleapis.com/fcm/send/eztCRzZQOuY:APA91bFV_p-Qy1x2D1Ci_gfOI8n7pb4UqJMoWHdXoJ_2f-CL15ag7QMgPM9x-ozhf68v5JtdZh0dgXFER2Qo20gV9QeM5KKOUxhK9yNRgZYCTJXLpKryCo7G6R48R3Ii0HW85670NgJI	BMAUpe0H9mcSQsaBn-5otTR-ElIBQu665MK0UyXz27ws6TzAvTo7OYp30SokckdUBQ71NjbBNRD24HRzRUBV9i0	VPxdapxQKlX4oqM-BU8Urw	2026-04-24 10:48:06.217341
\.
...
21	Ngô Thị Mỹ Hường	f	1990-10-30	2	fe60612a-cebd-4bd6-bdcd-e466dfe6e363
12	Lê Thị Thủy	f	1992-01-01	4	ad1cf668-28eb-491d-a8cb-015d033b5e9f
\.
...
--
-- Name: DamageReportHistory_ID_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."DamageReportHistory_ID_seq"', 742, true);


--
-- Name: DamageReport_ID_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."DamageReport_ID_seq"', 273, true);


--
-- Name: DeviceReminderPlan_ID_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public."DeviceReminderPlan_ID_seq"', 146, true);
...
SELECT pg_catalog.setval('public."Device_ID_seq"', 427, true);
...
SELECT pg_catalog.setval('public."Event_ID_seq"', 2291, true);
...
SELECT pg_catalog.setval('public."Location_ID_seq"', 39, true);
...
SELECT pg_catalog.setval('public."Notification_ID_seq"', 409, true);
...
SELECT pg_catalog.setval('public."PushSubscription_ID_seq"', 36, true);
...
--
-- Name: AspNetRoleClaims AspNetRoleClaims_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetRoles AspNetRoles_NormalizedName_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserTokens AspNetUserTokens_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUsers AspNetUsers_NormalizedEmail_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUsers AspNetUsers_NormalizedUserName_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory DamageReportHistory_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReport DamageReport_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DeviceCategory DeviceCategory_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan DeviceReminderPlan_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Staff Staff_UserId_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_aspnet_users_email; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_aspnet_users_username; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_department; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_device; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_handler; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_history_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_history_report; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_maintenance_batch; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_reporter; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_damage_report_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_device_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_device_department; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_device_reminder_plan_active_due; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_device_reminder_plan_device; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_device; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_event_related_report; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: ux_eventtype_code; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: AspNetRoleClaims AspNetRoleClaims_RoleId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserClaims AspNetUserClaims_UserId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserLogins AspNetUserLogins_UserId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserRoles AspNetUserRoles_RoleId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserRoles AspNetUserRoles_UserId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: AspNetUserTokens AspNetUserTokens_UserId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReportHistory DamageReportHistory_DamageReportID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReport DamageReport_DeviceID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReport DamageReport_HandlerID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReport DamageReport_ReporterID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DamageReport DamageReport_ReportingDepartmentID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan DeviceReminderPlan_DeviceID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: DeviceReminderPlan DeviceReminderPlan_EventTypeID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Device Device_DepartmentID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Device Device_DeviceCategoryID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Event Event_DeviceID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Event Event_RelatedReportID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Event Event_StaffID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Staff Staff_DepartmentID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: Device fk_device_location; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict zWIgdcBSfa3ZvnOT9CNJbVahbRPjzNcwYTzx8ODEnQfpWZyRHh8qwpIBeBgAHbA
